package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_494 = new FZipFile(charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  parseFunc = parseIdle;
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_638))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_638,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_94 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_638,"EOF"));
            }
         }
      }
      ...
      {
         if(var_494.parse(param1))
         {
            var_46.push(var_494);
            if(false)
            {
               var_132["null"] = var_494;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1354,var_494));
            var_494 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_46 != null && var_132 != null && param1 < var_46.length)
         {
