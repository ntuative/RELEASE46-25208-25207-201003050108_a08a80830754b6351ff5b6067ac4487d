package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_989:UserDataManager;
      ...
      {
         if(var_32 == RoomSessionEvent.const_289 && _connection != null)
         {
            var_32 = RoomSessionEvent.const_89;
            if(isPrivateRoom)
            {
      ...
      {
         return var_989 as IUserDataManager;
      }
