package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_95:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_621,_loc2_.userName));
               break;
            case RoomSessionDoorbellEvent.const_108:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_108,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_578];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_578:
      ...
      {
         return [RoomSessionDoorbellEvent.const_95,RoomSessionDoorbellEvent.const_108,RoomSessionDoorbellEvent.const_53];
      }
