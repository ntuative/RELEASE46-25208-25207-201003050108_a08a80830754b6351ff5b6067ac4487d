package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_609,RoomWidgetEcotronBoxOpenMessage.const_517,RoomWidgetEcotronBoxOpenedMessage.const_1129];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_609:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_517:
