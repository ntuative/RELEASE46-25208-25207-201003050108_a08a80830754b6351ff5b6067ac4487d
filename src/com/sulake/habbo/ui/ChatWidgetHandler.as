package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_747:Number = 0;
      
      private var var_437:Point = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_438.length)
            {
               _loc2_ = var_438.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_438.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_621.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    ...
                                    default:
                                       ...
                                       if(_loc16_ != null)
                                       {
                                          _loc13_ = _loc16_.getCroppedImage(AvatarSetType.const_44).clone();
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_438.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_621.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_703,RoomWidgetChatSelectAvatarMessage.const_567];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_703:
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_139,_container.roomSession,0,"Version 25208-25207-201003050040");
                     ...
                     switch(_loc3_.chatType)
                     {
                        ...
                        case RoomWidgetChatMessage.const_98:
                           ...
                           break;
                        case RoomWidgetChatMessage.const_114:
                           _container.roomSession.sendWhisperMessage(_loc3_.recipientName,_loc3_.text);
                     }
                  }
               }
               break;
            case RoomWidgetChatSelectAvatarMessage.const_567:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_747 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_747);
            }
            if(var_437 == null)
            {
               var_439.x = 0;
               var_439.y = 0;
               var_439.z = 0;
               var_437 = _loc4_.getScreenPoint(var_439);
               var_747 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_439.x = 0;
            var_439.y = 0;
            var_439.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_439);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_437.x || _loc8_.y != var_437.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_437,_loc5_));
