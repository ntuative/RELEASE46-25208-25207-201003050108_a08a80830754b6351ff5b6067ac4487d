   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_889,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_639,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_417,onHelpTutorialEvent);
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_97,onHelpTutorialEvent);
            }
            _container = null;
         }
         _container = param1;
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_639,onFigureUpdate);
         ...
         if(var_8 != null)
         {
            (var_8 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_937,onAvatarEffectsChanged);
            (var_8 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_810,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_417,onHelpTutorialEvent);
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_97,onHelpTutorialEvent);
         }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_97:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_97));
               break;
            case HabboHelpTutorialEvent.const_417:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_379));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_620);
         _loc1_.push(RoomWidgetDanceMessage.const_580);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_641);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_706);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_611);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_508);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_649);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_619);
         _loc1_.push(RoomWidgetStopEffectMessage.const_514);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1381);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_789);
         _loc1_.push(RoomWidgetToolbarMessage.const_731);
         _loc1_.push(RoomWidgetToolbarMessage.const_572);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_566);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1371);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_796);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_721);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_537);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_540);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_665);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1375);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_693);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_594);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_519);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_538));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_537:
               ...
               break;
            case RoomWidgetWaveMessage.const_620:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetDanceMessage.const_580:
               if(_container != null && false)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_706:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_611:
               if(var_8 != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_619:
               ...
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_516)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_256,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_649:
               ...
               if(var_8 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_976:
                        _catalog.openCatalogPage(CatalogPageName.const_1311,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1002:
                        var_8.toggleInventoryPage(InventoryCategory.const_251);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1320:
                        var_8.toggleInventoryPage(InventoryCategory.const_72);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1246:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_514:
            ...
            case RoomWidgetNavigateToRoomMessage.const_789:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_721:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_731:
               ...
               break;
            case RoomWidgetToolbarMessage.const_572:
               ...
               if(var_190 && false)
               {
                  var_190.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_386,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_566:
               ...
               if(_container)
               {
                  ...
                  if(false && _loc23_ == 0)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_358,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_990));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_358,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1293));
                     }
                  }
                  if(false && _container.habboHelp.events)
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_579));
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_540:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_665:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_322,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_693:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_322,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_594:
               _container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_322,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_519:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_674));
               }
               break;
            default:
