package com.sulake.habbo.ui
{
   ...
   public class ChatInputWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetChatInputWidgetMessage.const_623);
         _loc1_.push(RoomWidgetChatTypingMessage.const_691);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatInputWidgetMessage.const_623:
               ...
               break;
            case RoomWidgetChatTypingMessage.const_691:
      ...
      private function positionWindow(param1:IWindowContainer) : void
      {
         ...
         var_190.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_657,HabboToolbarIconEnum.CHATINPUT,param1));
