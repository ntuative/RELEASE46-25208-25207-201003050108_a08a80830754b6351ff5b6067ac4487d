package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_507);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_642);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_546);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_103:
            ...
            case FriendRequestEvent.const_246:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_507:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_642:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_546:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_103);
         _loc1_.push(FriendRequestEvent.const_53);
         _loc1_.push(FriendRequestEvent.const_246);
         return _loc1_;
      }
