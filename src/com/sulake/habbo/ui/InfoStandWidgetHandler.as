package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               ...
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_127,onBadgeImage);
            }
            if(false)
            {
         ...
         if(false)
         {
            ...
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_127,onBadgeImage);
         }
         if(false)
         {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_28:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_561);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_325);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_855);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_843);
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_395)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_1010)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_515);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_185)
               {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_202)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_633);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1220;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_933;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_805;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1312);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_583.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_51);
            var_583.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_633);
      ...
      {
         return [RoomSessionUserBadgesEvent.const_107];
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_283);
         _loc1_.push(RoomWidgetUserActionMessage.const_640);
         _loc1_.push(RoomWidgetUserActionMessage.const_565);
         _loc1_.push(RoomWidgetUserActionMessage.const_529);
         _loc1_.push(RoomWidgetUserActionMessage.const_725);
         _loc1_.push(RoomWidgetUserActionMessage.const_543);
         _loc1_.push(RoomWidgetUserActionMessage.const_411);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_241);
         _loc1_.push(RoomWidgetFurniActionMessage.const_542);
         _loc1_.push(RoomWidgetFurniActionMessage.const_652);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_690);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_615);
         _loc1_.push(RoomWidgetUserActionMessage.const_351);
         _loc1_.push(RoomWidgetUserActionMessage.const_699);
         _loc1_.push(RoomWidgetUserActionMessage.const_717);
         _loc1_.push(RoomWidgetUserActionMessage.const_1296);
         _loc1_.push(RoomWidgetPetCommandMessage.const_645);
         _loc1_.push(RoomWidgetPetCommandMessage.const_692);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_107:
      ...
      public function dispose() : void
      {
         ...
         if(var_583 != null)
         {
            _loc1_ = var_583.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_583.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_351)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_283:
            ...
            case RoomWidgetUserActionMessage.const_607:
               ...
               break;
            case RoomWidgetUserActionMessage.const_529:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_930,_loc3_.name);
               _container.events.dispatchEvent(_loc8_);
               break;
            case RoomWidgetUserActionMessage.const_725:
            ...
            case RoomWidgetUserActionMessage.const_543:
               ...
               break;
            case RoomWidgetUserActionMessage.const_411:
            ...
            case RoomWidgetUserActionMessage.const_414:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_690:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_615:
               ...
               break;
            case RoomWidgetUserActionMessage.const_351:
