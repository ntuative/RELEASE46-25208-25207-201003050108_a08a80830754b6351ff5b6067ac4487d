package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_1057:PaletteManager;
      
      private var var_699:PetDataManager;
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_307.getValue(AvatarType.const_85) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(var_97);
         }
         _loc2_ = var_307.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(var_97);
         }
      ...
      private function init() : void
      {
         ...
         var_699 = new PetDataManager(_loc1_,_loc3_);
         var_1057 = new PaletteManager(_loc1_,_loc3_);
         var _loc4_:XML = _assets.getAssetByName("HabboAvatarPetFigure").content as XML;
         var_699.populateFigureData(_loc4_);
      ...
      {
         var _loc5_:String = var_699.createAvatarFigureStringNew(param1,param2,param3);
         var _loc6_:AvatarStructure = var_307.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:AvatarStructure = var_307.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = var_307.getValue(AvatarType.const_85) as AvatarStructure;
         if(_loc3_ == null)
         {
            return null;
         }
