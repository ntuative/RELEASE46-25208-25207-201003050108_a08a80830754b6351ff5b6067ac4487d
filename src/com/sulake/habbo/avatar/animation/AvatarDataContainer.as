package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1391:Number = 1;
      
      private var _b:uint;
      
      private var var_1389:Number = 1;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1390,var_1389,var_1391,_alphaMultiplier);
         var_976 = generatePaletteMapForGrayscale(var_1819,var_1821);
      }
      
      public function get reds() : Array
      {
         return var_976.getValue("reds") as Array;
      }
      ...
      {
         return var_976.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_976.getValue("greens") as Array;
      }
      ...
      {
         return var_976.getValue("alphas") as Array;
      }
