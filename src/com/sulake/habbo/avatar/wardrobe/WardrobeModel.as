package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_1567:String = "hot_looks";
      
      public static const const_1575:String = "my_looks";
      ...
      public function WardrobeModel(param1:HabboAvatarEditor, param2:String = "")
      {
         ...
         var_555["null"] = new Array();
         var_555["null"] = new Array();
         var_555["undefined.index"] = 0;
         var_555["undefined.index"] = 0;
         initMyLooks();
         requestHotLooks();
      }
      ...
      {
         var _loc2_:Outfit = var_148[param1];
         if(_loc2_ != null)
         {
            if(_loc2_.figure == "")
            {
      ...
      public function updateMyLooks(param1:int, param2:Array) : void
      {
         ...
         {
            _loc5_ = var_148[_loc4_.slotId - 1];
            if(_loc5_ != null)
            {
               _loc5_.dispose();
            }
            _loc3_ = new Outfit(var_10,_loc4_.figureString,_loc4_.gender);
            var_148[_loc4_.slotId - 1] = _loc3_;
         }
         if(_view != null)
         {
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            for each(_loc5_ in _loc4_.habbo)
            {
               ...
               (var_555[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {
