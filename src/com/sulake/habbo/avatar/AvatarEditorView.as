package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1581:IWindowContainer;
      ...
      private var var_1499:Boolean = true;
      
      private var var_338:Timer;
      
      private var var_1498:ITabSelectorWindow;
      
      private var _window:IWindowContainer;
      
      private var var_489:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog)
      {
         ...
         if(var_1357 == null)
         {
            ...
            var_1357 = var_10.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
         if(var_1581 == null)
         {
            _loc5_ = var_10.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1581 = var_10.windowManager.buildFromXML(_loc5_.content as XML) as IWindowContainer;
         }
         var_338 = new Timer(1000);
         var_338.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!var_489)
         {
            ...
            var_489 = _windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            var_489.procedure = stripClubDialogEventProc;
            var_489.center();
         }
         else
         {
            var_489.visible = true;
            var_489.center();
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1498 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_706 != null)
         {
            toggleCategoryView(var_706,true);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            var_338.stop();
            var_338.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_338 = null;
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_706 = param1;
         var_1498.setSelected(var_1498.getSelectableByName(param1));
         _window.invalidate();
      }
