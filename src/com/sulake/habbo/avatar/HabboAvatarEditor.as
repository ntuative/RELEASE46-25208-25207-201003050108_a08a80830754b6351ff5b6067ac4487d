package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_605:AvatarEditorHandler;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_732.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_1338)
         {
            var_517 = new Dictionary();
            var_517["null"] = new FigureData(this);
            var_517["null"] = new FigureData(this);
            _loc1_ = var_517["null"];
            _loc2_ = var_517["null"];
            ...
            var_13 = new Map();
            var_13.add(AvatarEditorCategory.const_965,new GenericModel(this));
            var_13.add(AvatarEditorCategory.const_44,new HeadModel(this));
            var_13.add(AvatarEditorCategory.const_314,new TorsoModel(this));
            var_13.add(AvatarEditorCategory.const_1201,new LegsModel(this));
            var_13.add(AvatarEditorCategory.const_894,new WardrobeModel(this));
            var_1338 = true;
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_605 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_1079 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc14_.isSelectable && (_loc13_ || var_1079 >= _loc14_.clubLevel))
               {
                  _loc17_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1581.clone() as IWindowContainer,param1,_loc14_);
                  _loc4_.push(_loc17_);
            ...
            {
               _loc21_ = false;
               if(_loc5_.gender == FigureData.const_1230)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc5_.isSelectable && _loc21_ && (_loc16_ || var_1079 >= _loc5_.clubLevel))
               {
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_13.getValue(AvatarEditorCategory.const_894);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_732.getPalette(param1);
      }
      ...
      {
         var_732 = var_604.getFigureData(AvatarType.const_85);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_604 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_240 == null)
            {
               var_240 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_55,HabboWindowStyle.const_36,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_965);
         if(var_605 != null)
         {
            var_605.getWardrobe();
         }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_1079 = param3;
         var _loc4_:FigureData = var_517[param2];
         if(_loc4_ == null)
         {
            return;
         }
