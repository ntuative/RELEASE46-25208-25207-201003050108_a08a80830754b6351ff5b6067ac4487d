package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1057:String = AvatarSetType.const_37;
      
      private static const const_1060:String = "Default";
      
      private static const const_1058:int = 125;
       
      
      private var _avatarSubType:int = 0;
      
      private var var_561:AvatarFigureContainer;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String)
      {
         ...
         if(var_194 == null)
         {
            var_194 = AvatarScaleType.const_51;
         }
         ...
         var_561 = new AvatarFigureContainer(param3);
         if(param5 == AvatarType.PET)
         {
            _loc6_ = var_561.getPartSetId("pbd");
            solvePetAvatarTypeAndRace(_loc6_);
            _avatarSubType = var_1004;
         }
         var_127 = new AvatarImageCache(var_71,this,_assets,var_194);
         setDirection(const_1057,const_1059);
         var_193 = new Array();
         resetActions();
      }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc3_:* = null;
         param2 += var_1209;
         if(param2 < AvatarDirectionAngle.const_1217)
         {
            param2 = AvatarDirectionAngle.const_630 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_630)
         {
            param2 -= NaN;
         }
         if(var_729 == AvatarType.PET && param1 == AvatarSetType.const_44)
         {
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         _isAnimating = false;
         var _loc1_:Array = var_71.sortActions(var_193);
         if(_loc1_ == null)
         {
            var_560 = new Array(0,0,0);
         }
         else
         {
            var_560 = var_71.getCanvasOffsets(_loc1_,var_194,var_93);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc2_.definition.isAnimation)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_1209 = _loc3_.directionData.offset;
                  }
            ...
            if(_loc2_.actionType == AvatarAction.const_732)
            {
               _isAnimating = true;
            }
      ...
      {
         return var_71.getPartColor(var_561,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_71.getCanvas(var_194,var_169.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_71.getBodyParts(param1,var_169.definition,var_93);
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               if(var_729 == AvatarType.PET)
               {
                  _loc14_ = getCache().getBodyPartCache(_loc9_);
                  _loc15_ = _loc14_.getAction();
                  _loc16_ = _loc15_.definition.assetPartDefinition;
                  _loc17_ = var_71.getParts(_loc9_,var_561,_loc15_,"pet",_loc14_.getDirection());
                  _loc18_ = 32;
                  if(var_194 == AvatarScaleType.const_99)
                  {
                     _loc18_ = 6;
                  }
                  if(_loc17_.length > 0)
                  {
                     ...
                     _loc23_ = var_71.getPartActionOffset(getSubType(),var_194,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String) : BitmapData
      {
         ...
         {
            _loc3_ = var_71.getCanvas(var_194,var_169.definition.geometryType);
            if(_loc3_ == null)
            {
               return null;
            }
         ...
         var _loc4_:Array = var_71.getBodyParts(param1,var_169.definition,var_93);
         _image.lock();
         ...
         while(_loc6_ >= 0)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(var_729 == AvatarType.PET)
               {
                  ...
                  _loc14_ = var_71.getParts(_loc7_,var_561,_loc12_,"pet",_loc11_.getDirection());
                  ...
                  if(_loc14_.length > 0)
                  {
                     ...
                     _loc21_ = var_71.getPartActionOffset(getSubType(),var_194,_loc7_,_loc13_,_loc18_,_loc19_);
                     if(_loc21_ != null)
                     {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_169 = new ActiveActionData(AvatarAction.const_905);
         var_169.definition = var_71.getActionDefinition(const_1060);
      ...
      {
         return var_71.getBodyPartData(param1.animation.id,var_467,param1.id);
      }
