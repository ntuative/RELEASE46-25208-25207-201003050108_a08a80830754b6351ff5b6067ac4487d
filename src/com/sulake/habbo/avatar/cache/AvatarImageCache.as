package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1401:int = 60000;
      ...
      private var var_815:IAvatarImage;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         {
            _loc15_ = var_71.getBodyPartData(_loc5_.definition.state + "." + _loc5_.actionParameter,param2,param1);
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_726)
               {
                  _loc6_ = _loc15_.action;
                  _loc4_ = _loc8_;
               }
               else if(_loc15_.type == AnimationLayerData.const_375)
               {
                  _loc4_ = _loc8_;
               }
               _loc7_ = true;
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_71.getParts(param1,(var_815 as AvatarImage).getFigure(),_loc6_,var_1202,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_71.getCanvas(var_194,var_1202);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1300[param1])
            {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.const_902 || _loc32_ == AvatarAction.const_732) && (_loc6_ == AvatarBodyPartType.const_314 || _loc6_ == AvatarBodyPartType.const_1207 || _loc6_ == AvatarBodyPartType.const_1236) && _loc7_.color != null)
               {
         ...
         if(_loc20_)
         {
            if(var_194 == AvatarScaleType.const_51)
            {
               _loc30_.x += 67;
            }
            else
