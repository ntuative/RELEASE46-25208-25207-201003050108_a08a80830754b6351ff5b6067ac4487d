package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1416:Number = 15;
      
      private var _events:IEventDispatcher;
      
      private var var_276:ToolbarBarMenuAnimator;
      
      private var var_1415:Number = 5;
      ...
      private var var_961:Boolean = true;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_188 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_55,HabboWindowStyle.const_854,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_961 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_961)
         {
         ...
         var_1148 = _loc7_.toolbar.@margin_bottom;
         var_1416 = _loc7_.toolbar.@min_group_margin;
         var_1415 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_246,param1,param2,_window,var_276);
         createGroupsFromXmlList(_loc9_,var_539,param1,param2,var_188,var_276);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_123,var_448,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1416,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1148) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1416,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1148) / -1));
         ...
         _loc2_ = 0;
         while(_loc2_ < var_539.length)
         {
            _loc3_ = var_539[_loc2_];
            if(_loc3_ != null)
            {
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_123,var_448);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_539.length)
         {
            _loc2_ = var_539[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_448);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_123,var_448);
         }
      }
