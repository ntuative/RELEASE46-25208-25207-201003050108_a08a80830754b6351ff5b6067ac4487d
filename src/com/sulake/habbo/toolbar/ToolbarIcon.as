package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIcon
   {
      ...
      private var var_1063:ToolbarIconBouncer;
      ...
      public function ToolbarIcon(param1:ToolbarIconGroup, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IEventDispatcher, param6:ToolbarBarMenuAnimator)
      {
         ...
         var_874 = new Array();
         var_2320 = new Array();
         var_1063 = new ToolbarIconBouncer(0.8,1);
         super();
         var_509 = param1;
         ...
         _events = param5;
         var_276 = param6;
         var_1317 = new Timer(40,40);
         var_1317.addEventListener(TimerEvent.TIMER,updateBouncer);
         var_99 = param2.createWindow("TOOLBAR_ICON_" + param4 + "_REGION","",WindowType.const_409,HabboWindowStyle.const_39,HabboWindowParam.const_38,new Rectangle(0,0,1,1),onMouseEvent) as IRegionWindow;
      ...
      {
         return var_1539[var_1060.indexOf(param1)];
      }
      ...
      private function onMouseEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               if(var_276)
               {
                  var_276.repositionWindow(var_704,true);
               }
               if(_events != null)
               {
      ...
      public function menuLockedToIcon(param1:String) : Boolean
      {
         ...
         var _loc2_:MenuSettingsItem = var_874[var_596.indexOf(param1)];
      ...
      private function setTooltip() : void
      {
         ...
         {
            var_99.toolTipCaption = "${toolbar.icon.tooltip." + var_2130.toLowerCase() + "}";
         }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Number, param4:String, param5:Point) : void
      {
         if(var_276 != null)
         {
            var_276.animateWindowIn(this,param1,param2,var_704,param3,param4,getMenuYieldList(param1));
         }
      }
      
      private function updateAnimator(param1:Event) : void
      {
         if(var_418 != null && _window != null)
         {
            var_418.update(_window);
            if(var_418.hasNextState())
            {
               state = var_418.nextState;
            }
         }
      }
      ...
      public function defineFromXML(param1:XML) : void
      {
         ...
         var_1060 = new Array();
         var_2130 = param1.@id;
         var_2131 = int(param1.@window_offset_from_icon);
         var_1698 = int(param1.@window_margin);
         ...
         if(_loc2_.length() > 0)
         {
            ...
            while(_loc3_ < _loc2_.length())
            {
               ...
               var_1060.push(_loc5_.id);
               var_1539.push(_loc5_);
               if(_loc3_ == 0)
               {
                  if(var_1061 == "-1")
                  {
      ...
      public function hideWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(var_276 != null)
         {
            var_276.hideWindow(param1,param2,var_704,param3);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(var_276 != null)
         {
            var_276.positionWindow(this,param1,param2,var_704,param3,getMenuYieldList(param1));
         }
      }
      ...
      {
         if(var_1063 != null && _window != null)
         {
            var_1063.update();
            _window.y = var_1063.location;
         }
      }
      ...
      private function setAnimator() : void
      {
         ...
         if(_loc1_ != null && var_1062)
         {
            ...
            var_418 = new ToolbarIconAnimator(_loc1_,_assetLibrary,_window,var_85,_y,_bitmapData);
            if(false)
            {
      ...
      {
         return var_1698 + var_509.windowMargin;
      }
