package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_109,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_889,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_164,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_159,onSetToolbarIconStateEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_657,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_969,onHideWindowEvent);
         var_32 = true;
