package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_878:IWindow;
      
      private var var_377:Number;
      
      private var var_876:ITextWindow;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_878 = _window.findChildByName("effect_hilite");
            var_878.visible = false;
         }
         var_876 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_877 = _window.findChildByName("loader_bar");
         if(var_877 != null)
         {
            var_377 = var_877.width;
            var_171.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_876 != null)
         {
            var_876.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_876.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
