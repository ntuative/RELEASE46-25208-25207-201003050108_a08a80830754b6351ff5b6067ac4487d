package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1619:uint = 6710886;
      ...
      private const const_1622:String = "energy";
      
      private var var_1274:Map;
      
      private const const_1621:String = "nutrition";
      
      private var var_60:IItemListWindow;
      
      private const const_1616:uint = 3355443;
      
      private var var_235:IBorderWindow;
      
      private const const_1617:int = 158;
      
      private const const_1614:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_266:PetCommandTool;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_235 != null)
         {
            var_106 = var_235.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_106 == null || var_235 == null || var_60 == null)
         {
            return;
         }
         ...
         var_235.height = NaN;
         _window.width = Math.max(var_235.width,var_60.width);
      ...
      private function openTrainView() : void
      {
         if(var_266 == null)
         {
            var_266 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1274.getValue(var_731) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_266.showWindow(true);
            var_266.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         updateStateElement(const_1622,param1.energy,param1.energyMax);
         updateStateElement(const_1621,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_731 = param1.id;
         var_1274.remove(param1.id);
         var_1274.add(param1.id,param1);
         if(var_266 && var_266.isVisible() && param1.isOwnPet)
         {
            var_266.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_266.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_411,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1617,const_1614,false);
