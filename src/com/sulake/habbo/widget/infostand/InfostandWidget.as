package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private var var_1274:InfoStandPetData;
      
      private var var_121:Timer;
      
      private var var_755:InfoStandFurniView;
      
      private var var_426:InfostandFurniData;
      
      private var var_321:InfoStandBotView;
      
      private var _mainContainer:IWindowContainer;
      
      private const const_1393:String = "infostand_bot_view";
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_755 = new InfoStandFurniView(this,const_1394);
         var_184 = new InfoStandUserView(this,const_1392);
         var_286 = new InfoStandPetView(this,const_1391);
         var_321 = new InfoStandBotView(this,const_1393);
         var_424 = new InfostandUserData();
         var_426 = new InfostandFurniData();
         var_1274 = new InfoStandPetData();
         var_121 = new Timer(const_1599);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_184.setTags(param1.tags,var_1605);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_268,onRoomObjectRemoved);
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_561,onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetUserBadgesUpdateEvent.const_107,onUserBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_581,onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_414,var_286.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_268,onRoomObjectRemoved);
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_561,onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetUserBadgesUpdateEvent.const_107,onUserBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_581,onBadgeImage);
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            if(userData.isBot())
            {
               var_321.setBadgeImage(_loc2_,param1.badgeImage);
            }
            else
            {
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_268:
               ...
               {
                  _loc2_ = param1.id == var_1274.roomIndex;
                  break;
               }
