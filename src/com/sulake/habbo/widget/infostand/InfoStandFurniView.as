package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      {
         var _loc2_:ITextWindow = var_106.getListItemByName("expiration_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_106.getListItemByName("expiration_spacer") as IWindowContainer;
