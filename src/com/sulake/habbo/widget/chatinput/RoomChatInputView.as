package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_493:int = 16;
      
      private static const const_1085:int = 20;
      ...
      private var var_377:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1030 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_2012 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2013 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_681 = new Timer(1000,1);
         var_681.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_837 = new Timer(5000,1);
         var_837.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_132,windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_43,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_149,onInputChanged);
         _window.addEventListener(WindowEvent.const_421,onWindowMoved);
         var_1259 = true;
         var_131 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2011 = _loc2_.width + const_493 + _loc6_.width + const_1085;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1086,_loc8_.width) + const_493);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1030 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_131 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_377);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_377);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_490);
