package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_381,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_480,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_468,onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_381,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_480,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_468,onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_63:
               ...
               showInterface();
               break;
            case RoomWidgetPresentDataUpdateEvent.const_381:
               if(!var_210)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_480:
               if(!var_210)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_468:
               if(!var_210)
               {
                  return;
               }
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_673,var_145);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_55,HabboWindowStyle.const_36,0 | 0,new Rectangle(const_1028,const_1029,2,2),null,0) as IWindowContainer;
         ...
         if(_loc4_ != null && var_187 != null)
         {
            _loc4_.caption = var_187;
         }
