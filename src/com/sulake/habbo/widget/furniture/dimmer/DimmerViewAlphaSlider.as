package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_91 && param1.type != WindowMouseEvent.const_403)
         {
            return;
         }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && var_550 != null)
            {
               _loc2_.bitmap = new BitmapData(var_550.width,var_550.height,true,16777215);
               _loc2_.bitmap.copyPixels(var_550,var_550.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = buttonProcedure;
               var_1437 = _loc1_.width - _loc2_.width;
            }
         }
      }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_550 = BitmapData(_loc2_.content);
      }
      ...
      {
         return int(var_1437 * (Number(param1 - var_648) / (var_985 - var_648)));
      }
      ...
      {
         return int(param1 / var_1437 * (var_985 - var_648)) + var_648;
      }
   }
}
