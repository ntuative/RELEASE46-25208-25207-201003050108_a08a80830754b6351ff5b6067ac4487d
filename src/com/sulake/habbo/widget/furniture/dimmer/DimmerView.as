package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_359:DimmerViewAlphaSlider;
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = var_232.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            var_232.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_55,HabboWindowStyle.const_36,0 | 0,new Rectangle(const_1028,const_1029,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            var_359 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
         var_232 = ITabContextWindow(_window.findChildByName("tab_context"));
         selectTab(_widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < var_232.numTabItems)
         {
            _loc6_ = var_232.getTabItemAt(_loc2_);
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = var_232.selector.getSelected();
         return var_232.selector.getSelectableIndex(_loc1_);
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_359 != null)
         {
            var_359.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_1086 = _loc2_.light;
         if(var_359 != null)
         {
            var_359.setValue(var_1086);
         }
         var_371 = colors.indexOf(_loc2_.color);
         if(var_520 != null)
         {
            var_520.setSelectedColorIndex(var_371);
         }
