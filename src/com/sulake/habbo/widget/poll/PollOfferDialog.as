package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_257:String = "POLL_OFFER_STATE_UNKNOWN";
      
      public static const const_588:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_1205:String = "POLL_OFFER_STATE_OK";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     var_32 = const_1205;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_656,_id));
                     break;
                  case "poll_offer_button_cancel":
                     var_32 = const_588;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_388,_id));
