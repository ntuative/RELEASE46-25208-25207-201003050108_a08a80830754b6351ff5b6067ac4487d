package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private var var_335:Number = 1;
      
      private var _widget:RoomChatWidget;
      
      private var var_299:Boolean = false;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_150.state = RoomChatHistoryPulldown.const_226;
         ...
         var_42 = param2.createWindow("chatscroller","",HabboWindowType.const_992,HabboWindowStyle.const_39,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      {
         return !!var_299 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_223 > 0 && param2)
         {
            if(var_1228)
            {
               if(Math.abs(param1 - var_223) <= const_847)
               {
                  return;
               }
               var_1228 = false;
            ...
            if(var_299)
            {
               ...
               _loc3_ = var_335 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - var_223;
               _loc7_ = true;
               _loc8_ = true;
               if(var_42.scrollV < 1 - const_1069 / var_42.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1489)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_299 && !var_1339)
         {
            ...
            var_150.state = RoomChatHistoryPulldown.const_287;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_150.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_226);
      }
