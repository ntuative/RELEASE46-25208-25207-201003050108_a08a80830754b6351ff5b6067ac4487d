package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_493:int = 6;
      
      private static const const_346:int = 10;
      
      private static const const_1103:Number = 18;
      
      private static const const_1415:Number = 10;
      
      private static const const_1416:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_1054,var_1052,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1054,var_1052,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1305 = param1.chatType;
         var_1054 = param1.userId;
         var_868 = param1.userName;
         var_1052 = param1.userCategory;
         _message = param1.text;
         var_1307 = param1.userX;
         var_203 = param1.userImage;
         var_1053 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         if(var_203 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_415 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1053 != 0)
            {
               _loc30_ = uint(var_1053 >> 16 & 255);
               _loc31_ = uint(var_1053 >> 8 & 255);
               _loc32_ = uint(var_1053 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_346;
            }
            else
            {
               _loc19_.text = var_868 + ":";
               _loc19_.y += var_415;
               _loc19_.width = _loc19_.textWidth + const_346;
               _width += _loc19_.textWidth + const_346;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1305 == RoomWidgetChatUpdateEvent.const_236)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_868);
            }
            else if(var_1305 == RoomWidgetChatUpdateEvent.const_270)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_868);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_415;
            _loc20_.width = _loc20_.textWidth + const_493;
            _width += _loc20_.textWidth + const_493;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_346 + _loc20_.textWidth + const_493;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1054,var_1052,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1054,var_1052,_roomId,_roomCategory,param1);
      }
