package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1549,var_1548);
         }
      }
      ...
      {
         if(param1 != var_1997 || param2 != var_1994)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1630);
      }
      ...
      {
         if(var_10 != null && false && var_237 != null)
         {
            var_10.furniModel.removeLockFrom(var_237.id);
            var_237 = null;
         }
      }
