package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_151 && false)
         {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1325 && param1.type == RoomEngineObjectEvent.const_189)
         {
            var_10.showView();
            var_1325 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1325 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_34,RoomObjectTypeEnum.const_303,_loc3_.figure);
            var_10.closeView();
            return;
         }
      ...
      {
         if(var_956.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
