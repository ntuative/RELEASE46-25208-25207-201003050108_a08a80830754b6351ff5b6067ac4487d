package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private var var_301:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_504 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      private function selectFirst() : void
      {
         ...
         setSelectedGridItem(var_570.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_301 != null)
         {
            var_301.setSelected(false);
         }
         var_301 = param1;
         if(var_301 != null)
         {
            var_301.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_301.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_570.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_504.removeGridItem(_loc2_.window);
         if(var_301 == _loc2_)
         {
            var_301 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_570.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_504.addGridItem(_loc2_.window);
            var_570.add(param1.id,_loc2_);
            if(var_301 == null)
            {
               selectFirst();
            }
