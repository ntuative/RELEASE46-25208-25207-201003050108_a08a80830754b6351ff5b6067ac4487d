package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2271:BitmapData;
      
      protected var var_931:Boolean;
      
      protected var var_2264:Boolean;
      
      protected var var_2074:int;
      ...
      protected var var_363:BitmapData;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_601)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1482));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1375);
         }
         if(_loc1_.id > 0)
         {
