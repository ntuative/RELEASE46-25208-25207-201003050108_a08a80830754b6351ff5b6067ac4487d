package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_771:IRoomSession;
      ...
      override public function dispose() : void
      {
         ...
         if(var_19 != null)
         {
            var_19.events.removeEventListener(RoomSessionEvent.const_89,roomSessionEventHandler);
            var_19.events.removeEventListener(RoomSessionEvent.const_101,roomSessionEventHandler);
            var_19.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_348,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_101:
               var_771 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_348:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_44.getValue(InventoryCategory.const_539));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_44.getValue(InventoryCategory.const_72));
      }
      ...
      {
         var_155.clubPeriods = param1;
         var_155.clubDays = param2;
         var_155.clubHasEverBeenMember = param3;
      ...
      {
         return PetsModel(var_44.getValue(InventoryCategory.const_151));
      }
      ...
      {
         return AchievementsModel(var_44.getValue(InventoryCategory.const_305));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_227:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_770.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_770.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_44.getValue(InventorySubCategory.const_227));
      }
      ...
      {
         return var_155.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_44.getValue(InventoryCategory.const_366) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_960 = new IncomingMessages(this);
      ...
      {
         return var_155.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_155.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_44.getValue(InventoryCategory.const_251));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionEvent.const_89,roomSessionEventHandler);
         var_19.events.addEventListener(RoomSessionEvent.const_101,roomSessionEventHandler);
         var_19.events.addEventListener(RoomSessionPropertyUpdateEvent.const_348,roomSessionEventHandler);
         ...
         var_44.add(InventoryCategory.const_366,_loc3_);
         ...
         var_44.add(InventoryCategory.const_151,_loc10_);
