package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_240:uint = 3;
      
      public static const const_171:uint = 1;
      
      public static const const_173:uint = 0;
      
      public static const const_1335:uint = 9;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_466 = false;
         var_660 = false;
         var_45.updateItemList(var_661);
         var_45.updateItemList(var_1197);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_45.alertPopup(TradingView.const_880);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               var_466 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               var_45.alertPopup(TradingView.const_901);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_32 + " NEW STATE: " + param1 + " OWN: " + var_466 + " OTHER: " + var_660);
         ...
         {
            case const_173:
               if(param1 == const_171 || param1 == const_224)
               {
                  var_32 = param1;
                  _loc2_ = true;
               }
      ...
      public function close() : void
      {
         if(var_558)
         {
            if(var_32 != const_173 && var_32 != const_224)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_173;
            var_8.toggleInventorySubPage(InventorySubCategory.const_999);
            var_558 = false;
         }
         var_45.setMinimized(false);
      }
