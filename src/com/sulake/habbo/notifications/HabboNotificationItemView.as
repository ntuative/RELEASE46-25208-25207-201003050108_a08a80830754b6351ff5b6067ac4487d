package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      private static const const_343:Number = 50;
      ...
      private var var_2203:Map;
      
      private var var_32:int;
      
      private var var_1020:uint;
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         if(_window.height < var_1492)
         {
            _window.height = var_1492;
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(var_32)
         {
            ...
            case const_466:
               var_829 += param1;
               _loc2_ = Number(var_829) / Number(var_395["time_fade_in"]);
               if(var_829 > int(var_395["time_fade_in"]))
               {
                  startDisplay();
               }
               adjustBlend(_loc2_);
            ...
            case const_762:
               var_1020 += param1;
               if(var_1020 > int(var_395["time_display"]) && !var_1241)
               {
                  startFadeOut();
               }
               break;
            case const_763:
               var_828 += param1;
               _loc3_ = 1 - Number(var_828) / Number(var_395["time_fade_out"]);
               adjustBlend(_loc3_);
               if(var_828 > int(var_395["time_fade_in"]))
               {
                  startIdling();
               }
         }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = var_190.orientation == "TOP" ? int(const_343) : 0;
         var _loc4_:int = var_190.orientation == "BOTTOM" ? int(_loc2_.height - const_343) : int(_loc2_.height);
         var _loc5_:int = var_190.orientation == "LEFT" ? int(const_343) : 0;
         var _loc6_:int = var_190.orientation == "RIGHT" ? int(_loc2_.width - const_343) : int(_loc2_.width);
         if(false)
         {
            if(false)
            {
