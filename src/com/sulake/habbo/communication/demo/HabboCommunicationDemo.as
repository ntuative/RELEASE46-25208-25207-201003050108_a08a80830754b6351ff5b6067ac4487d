package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_163:HabboHotelView;
      ...
      private var var_1623:PseudoRandom;
      ...
      private var var_441:IKeyExchange;
      ...
      private var var_69:IHabboCommunicationManager;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_312:
               _loc3_ = var_97.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_793:
               _loc3_ = var_97.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_877:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1624)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_625 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_625);
            _loc2_.send(_loc4_);
      ...
      {
         var_941 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_211);
         param1.send(new VersionCheckMessageComposer(401,var_1112,var_1625));
         var _loc2_:String = "";
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_441.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_441.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1623);
      ...
      {
         var_625 = var_97.getKey("sso.ticket",null);
         var_1112 = var_97.getKey("flash.client.url","");
         var_1625 = var_97.getKey("external.variables.txt","");
         if(var_163 == null)
         {
            var_163 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_625 != null)
         {
            var_69.mode = HabboConnectionType.const_473;
            var_69.initConnection(HabboConnectionType.const_273);
         }
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            var_69 = param2 as IHabboCommunicationManager;
            _loc3_ = var_69.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            var_69.addHabboConnectionMessageEvent(new HelloMessageEvent(onHelloEvent));
            var_69.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(onInitCrypto));
            var_69.addHabboConnectionMessageEvent(new SecretKeyEvent(onSecretKeyEvent));
            var_69.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(onSessionParamsEvent));
            var_69.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
            var_69.addHabboConnectionMessageEvent(new PingMessageEvent(onPing));
            var_69.addHabboConnectionMessageEvent(new ErrorReportEvent(onErrorReport));
            var_69.addHabboConnectionMessageEvent(new UserObjectEvent(onUserObject));
            var_69.addHabboConnectionMessageEvent(new GenericErrorEvent(onGenericError));
            var_69.addHabboConnectionMessageEvent(new DisconnectReasonEvent(onDisconnectReason));
            var_69.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(onRoomEntryInfoEvent));
            var_69.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(onUniqueMachineId));
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = var_69.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_603);
            _loc3_ = new InitCryptoMessageComposer(var_69.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1623 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_69.mode)
         {
            case HabboConnectionType.const_473:
               _loc6_ = "";
               ...
               var_940 = _loc4_;
               var_163.loadBannerImage(_loc7_ + "?token=" + var_940,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1229:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1188:
               var_939 = generateRandomHexString(30);
               var_441 = new DiffieHellman(new BigInteger(var_97.getKey("connection.development.prime"),16),new BigInteger(var_97.getKey("connection.development.generator"),16));
               var_441.init(var_939);
               _loc8_ = var_441.getPublicKey(10);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_163.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_940);
         ...
         var _loc9_:IConnection = var_69.getHabboMainConnection(null);
         ...
         var_441 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_939 = generateRandomHexString(30);
            var_441.init(var_939);
            _loc12_ = var_441.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(var_97).events.addEventListener(HabboConfigurationEvent.const_172,onConfigurationLoaded);
         }
      }
