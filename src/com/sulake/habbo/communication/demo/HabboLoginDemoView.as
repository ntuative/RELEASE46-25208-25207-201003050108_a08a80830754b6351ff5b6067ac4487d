package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private var var_327:HabboCommunicationDemo;
      
      public var password:String = "";
      
      private var var_111:SSOTicket;
      ...
      {
         var_327.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_327.shockwaveClientUrl = var_111.shockwaveClientUrl;
         var_327.ssoTicket = var_111.ticket;
         var_111.removeEventListener(SSOTicket.const_301,onParsedTicketSuccess);
         var_111.removeEventListener(SSOTicket.const_267,onParsedTicketFailure);
         var_111 = null;
      ...
      {
         var _loc1_:XmlAsset = (var_327 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_327.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_357,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_327.windowManager.buildFromXML(_loc2_) as IWindowContainer;
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_327.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_327.habboCommunication.habboWebLogin(name,password);
         var_111 = new SSOTicket(var_327.assets,_loc2_,_loc1_);
         var_111.addEventListener(SSOTicket.const_301,onParsedTicketSuccess);
         var_111.addEventListener(SSOTicket.const_267,onParsedTicketFailure);
      }
