package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      {
         var_1486 = getTimer();
         var_476.add(var_1224,var_1486);
         _connection.send(new LatencyPingRequestMessageComposer(var_1224));
         ++var_1224;
      }
      ...
      public function init() : void
      {
         ...
         var_1484 = int(var_168.getKey("latencytest.interval"));
         var_1485 = int(var_168.getKey("latencytest.report.index"));
         var_1955 = int(var_168.getKey("latencytest.report.delta"));
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var_149.push(_loc4_);
         if(var_149.length == var_1485 && var_1485 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - var_1483) > var_1955 || var_1483 == 0)
            {
               var_1483 = _loc9_;
