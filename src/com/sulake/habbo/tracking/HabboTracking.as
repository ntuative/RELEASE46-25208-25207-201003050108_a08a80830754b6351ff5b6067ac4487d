package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_753:uint = 11;
       
      
      private var var_217:LatencyTracker = null;
      ...
      private var var_384:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_994:int = -1;
      
      private var var_1180:LagWarningLogger = null;
      
      private var var_791:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_217 = new LatencyTracker();
         var_1180 = new LagWarningLogger();
         var_1179 = new Array(const_753);
         var _loc4_:int = 0;
         while(_loc4_ < const_753)
         {
            var_1179[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1171,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1324,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1351,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_678,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_818,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_603:
               trackLoginStep(HabboLoginTrackingStep.const_1291,String(_communication.port));
               break;
            case HabboCommunicationEvent.const_211:
               trackLoginStep(HabboLoginTrackingStep.const_211);
               break;
            ...
            case HabboCommunicationEvent.const_201:
               ...
               trackLoginStep(HabboLoginTrackingStep.const_201);
               if(var_217 != null)
               {
                  var_217.init();
               }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_217 != null)
            {
               var_217.communication = _communication;
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_321:
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_168)
         {
            Component(var_168).events.addEventListener(HabboConfigurationEvent.const_172,onConfigurationLoaded);
            if(var_217 != null)
            {
               var_217.configuration = var_168;
            }
            if(var_218 != null)
            {
               var_218.configuration = var_168;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _adManager.events.addEventListener(AdEvent.const_424,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_1873)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1332);
            var_1873 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_818,String(_loc2_.guestRoomId));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_603,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_211,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_201,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_701,onHotelViewEvent);
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_477:
               var_1180.registerWarning(LagWarningLogger.const_944);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_791)
            {
               var_791.release(new IIDHabboWindowManager());
               var_791 = null;
            }
            if(_adManager)
            {
            ...
            if(var_167)
            {
               if(true)
               {
                  ...
                  Component(var_167).events.removeEventListener(HabboFriendListTrackingEvent.const_321,onFriendlistTrackingEvent);
               }
            ...
            if(var_384)
            {
               if(true)
               {
                  var_384.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_384.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_384.release(new IIDHabboHelp());
               var_384 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_477,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_168)
         {
            Component(var_168).events.removeEventListener(HabboConfigurationEvent.const_172,onConfigurationLoaded);
         }
      }
      ...
      private function onLocalizationLoaded(param1:Event) : void
      {
         ...
         trackLoginStep(HabboLoginTrackingStep.const_93);
         if(_localization)
         {
            Component(_localization).events.removeEventListener(LocalizationEvent.const_93,onLocalizationLoaded);
         }
      }
      
      private function onHelpReady(param1:IID, param2:IUnknown) : void
      {
         var_384 = param2 as IHabboHelp;
         var_384.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_384.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_795);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_795,onCoreRunning);
         }
      }
      ...
      {
         var_791 = IHabboWindowManager(param2);
         if(var_791)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_994 > -1 && _loc2_ < var_994)
         {
            ++var_1445;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1445);
         }
         if(var_994 > -1 && _loc2_ - var_994 > 15000)
         {
            ++var_1446;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1446);
         }
         var_994 = _loc2_;
         if(var_218 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_477,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_250,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_167).events.addEventListener(HabboFriendListTrackingEvent.const_321,onFriendlistTrackingEvent);
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.addEventListener(LocalizationEvent.const_93,onLocalizationLoaded);
         }
      }
      
      private function onHotelViewEvent(param1:Event) : void
      {
         if(param1.type == HabboHotelViewEvent.const_701)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1350);
         }
