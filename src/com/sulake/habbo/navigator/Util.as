package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1412:CutToHeight = new CutToHeight();
      
      private static var var_1411:CutToWidth = new CutToWidth();
      ...
      public static function method_4(param1:String) : String
      {
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1412.beforeSearch(param2,param1,param3);
         binarySearch(var_1412,param2.length - 1);
      }
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1411.beforeSearch(param2,param1,param3);
         binarySearch(var_1411,param2.length - 1);
      }
   }
}
