package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_473:IDropMenuWindow;
      
      private var var_2363:IWindowContainer;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_637;
         }
         if(param1 == 2)
         {
            return Tabs.const_595;
         }
         if(param1 == 3)
         {
         ...
         return Tabs.const_219;
      }
      
      private function startSearch() : void
      {
         var _loc1_:int = var_473 == null ? 0 : int(var_473.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_272,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_473 == null)
         {
            var_473 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_473.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
