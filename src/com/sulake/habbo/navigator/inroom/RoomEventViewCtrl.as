package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_1109:IButtonWindow;
      ...
      private var var_623:TextFieldManager;
      ...
      private var var_753:IDropMenuWindow;
      
      private var var_1107:IButtonWindow;
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = var_623.getText();
         var _loc6_:Array = new Array();
         addTag(_loc6_,var_754.getText());
         addTag(_loc6_,var_752.getText());
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         var_1604.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_623.setText(param1.eventDescription);
         var_754.setText(getTagFromEvent(param1,1));
         var_752.setText(getTagFromEvent(param1,2));
         var_1109.visible = false;
         var_1107.visible = true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1604 = ITextWindow(find("event_type_disabled_text"));
            var_1377 = ITextWindow(find("create_caption"));
            var_1378 = ITextWindow(find("edit_caption"));
            var_1109 = IButtonWindow(find("create_button"));
            var_1107 = IButtonWindow(find("edit_button"));
            var_1603 = IButtonWindow(find("cancel_button"));
            var_1108 = IButtonWindow(find("end_button"));
            var_753 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1109,onCreateButtonClick);
            Util.setProcDirectly(var_1107,onEditButtonClick);
            Util.setProcDirectly(var_1108,onEndButtonClick);
            Util.setProcDirectly(var_1603,onCancelButtonClick);
            _eventNameInput = new TextFieldManager(_navigator,getInput("event_name"),25);
            var_623 = new TextFieldManager(_navigator,getInput("event_desc"),100);
            var_754 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
            var_752 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!var_623.checkMandatory(_navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function createEvent() : void
      {
         ...
         var_1109.visible = true;
         var_1107.visible = false;
         var_1108.visible = false;
         var_623.goBackToInitialState();
         _eventNameInput.goBackToInitialState();
         var_754.goBackToInitialState();
         var_752.goBackToInitialState();
         var_753.selection = 0;
