package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2359:Dictionary;
      ...
      private var var_800:RoomCreateViewCtrl;
      
      private var var_1898:RoomThumbnailRenderer;
      ...
      private var var_387:Tabs;
      
      private var var_256:MainViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_256 = new MainViewCtrl(this);
         var_556 = new RoomInfoViewCtrl(this);
         var_800 = new RoomCreateViewCtrl(this);
         var_1898 = new RoomThumbnailRenderer(this);
         var_971 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_387 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_256.startSearch(Tabs.const_187,Tabs.const_333,param1);
         var_256.mainWindow.activate();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_801)
         {
            var_801.release(new IIDSessionDataManager());
            var_801 = null;
         }
         if(_catalog)
         {
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_190 != null)
         {
            var_190.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_109,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_190.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_109,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_801 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_256.startSearch(Tabs.const_272,Tabs.const_219);
         var_387.getTab(Tabs.const_272).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_256.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
