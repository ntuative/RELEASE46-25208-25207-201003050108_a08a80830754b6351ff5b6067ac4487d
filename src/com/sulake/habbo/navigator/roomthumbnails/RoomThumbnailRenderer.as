package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1125:int = -16;
      
      private static const const_784:int = 32;
      
      private static const const_1124:int = 8;
      
      public static const const_463:int = 10;
      
      private static const const_1126:int = 40;
      ...
      private var var_2231:Dictionary;
      
      private var var_907:ThumbnailImageConfigurations;
      
      private var var_1348:BitmapData;
      
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         var_1085 = new Dictionary();
         super();
         _navigator = param1;
         var_907 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_907.getImage(ThumbnailEditorModel.const_32,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1125,_loc4_.y + const_1126 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2231[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_907.getImage(ThumbnailEditorModel.const_35,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_907.getImage(ThumbnailEditorModel.const_35,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_907.getImage(ThumbnailEditorModel.const_52,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_784 / 2);
         return new Point(param1 * const_784 + _loc3_,param2 * const_1124);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         var _loc4_:* = null;
         _loc3_ = 0;
         while(_loc3_ <= const_463)
         {
            var_1085[_loc3_] = null;
            _loc3_++;
         }
         for each(_loc4_ in param2)
         {
            var_1085[_loc4_.pos] = _loc4_;
         }
         _loc3_ = 0;
         while(_loc3_ <= const_463)
         {
            if(false)
            {
               refreshObj(param1,var_1085[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1348 == null)
         {
            var_1348 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1348,var_1348.rect,new Point(0,0),null,null,true);
      }
   }
}
