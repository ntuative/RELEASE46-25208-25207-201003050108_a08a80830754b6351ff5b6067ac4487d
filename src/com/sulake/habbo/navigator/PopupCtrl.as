package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         var_336.addEventListener(TimerEvent.TIMER,onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(var_336)
         {
            var_336.removeEventListener(TimerEvent.TIMER,onDisplayTimer);
            var_336.reset();
            var_336 = null;
         }
         if(var_300)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(var_49 == null)
         {
            var_49 = IWindowContainer(_navigator.getXmlWindow(var_1134));
            var_49.visible = false;
            var_49.setParamFlag(HabboWindowParam.const_38,true);
         ...
         var_49.x = _loc2_.x + var_1795 + param1.width;
