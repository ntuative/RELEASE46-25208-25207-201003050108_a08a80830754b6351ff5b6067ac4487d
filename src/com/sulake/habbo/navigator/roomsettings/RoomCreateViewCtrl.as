package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_830:RoomLayout;
      ...
      private var var_1023:TextFieldManager;
      
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_481 = new Timer(100);
         var_481.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_62 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_1023 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1023.getText();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var_1594 = _navigator.data.hcMember;
      }
      ...
      public function dispose() : void
      {
         if(var_481)
         {
            var_481.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_481.reset();
            var_481 = null;
         }
      }
      ...
      {
         var_1023.goBackToInitialState();
         var_1023.input.textBackgroundColor = 4294967295;
         var_830 = var_62[0];
         if(var_1594 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_55,HabboWindowStyle.const_36,HabboWindowParam.const_64,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc1_:Boolean = var_1023.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_830.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1245 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1245 = true;
            _loc3_.y = 1;
