package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1151:TextFieldManager;
      ...
      private var var_1157:TextFieldManager;
      ...
      private var var_1154:ICheckBoxWindow;
      
      private var var_1153:ICheckBoxWindow;
      
      private var _navigator:HabboNavigator;
      
      private var var_1156:ICheckBoxWindow;
      ...
      private function populateForm() : void
      {
         ...
         var_781.setText(_loc1_.name);
         var_1157.setText(_loc1_.description);
         var_971.setText("");
         var_1151.setText("");
         ...
         setTag(var_754,_loc1_.tags[0]);
         setTag(var_752,_loc1_.tags[1]);
         if(var_1156)
         {
            if(_loc1_.allowPets)
            {
               this.var_1156.select();
            }
            else
            {
               this.var_1156.unselect();
            }
         }
         if(var_1153)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_55,HabboWindowStyle.const_36,HabboWindowParam.const_64,new Rectangle(0,0,100,20)));
      }
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1425.visible = _inRoom;
         var_1423.visible = _inRoom;
         var_1809.visible = var_451;
         var_1810.visible = !var_451;
         if(var_451)
         {
         ...
         else
         {
            ...
            var_1152.visible = _inRoom;
            _navigator.thumbRenderer.refreshThumbnail(IWindowContainer(var_1152.findChildByName("picframe")),_navigator.data.enteredGuestRoom.thumbnail,false);
            var_969.height = Util.getLowestPoint(this.var_969) + 4;
         }
         var_1424.text = !!var_451 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1425.name,var_1152.name,var_969.name,var_972.name,var_1155.name,var_1423.name],0,0);
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = var_781.getText();
         _loc2_.description = var_1157.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_373;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_128)
         {
            _loc8_ = var_971.getText();
            _loc9_ = var_1151.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_971.clearErrors();
               this.var_1151.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = var_1156.isSelected;
         _loc2_.allowFoodConsume = var_1153.isSelected;
         _loc2_.allowWalkThrough = var_1154.isSelected;
         _loc2_.tags = new Array();
         addTag(var_754,_loc2_.tags);
         addTag(var_752,_loc2_.tags);
         this.clearErrors();
      ...
      {
         if(param1 != this.var_378 || var_970 < 1)
         {
            return;
         }
         close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         var_970 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1146)
         {
            this.var_781.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1263)
         {
            this.var_781.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1272)
         {
            this.var_1157.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1362)
         {
            setTagError(this.var_754,param3,"${navigator.roomsettings.unacceptablewords}");
            setTagError(this.var_752,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1261)
         {
            setTagError(this.var_754,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            setTagError(this.var_752,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         ...
         {
            this.var_781.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_723,onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_966,onDoorModePasswordUnselect);
         ...
         this.var_781 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("room_name")),60);
         this.var_1157 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_754 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_752 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         this.var_971 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         this.var_1151 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         this.var_1156 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1153 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1154 = ICheckBoxWindow(_window.findChildByName("allow_walk_through_checkbox"));
         var_1425 = IWindowContainer(_window.findChildByName("header_container"));
         var_1152 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         ...
         var_1423 = IWindowContainer(_window.findChildByName("switch_view_container"));
         var_1155 = IWindowContainer(_window.findChildByName("footer_container"));
         var_247 = IWindowContainer(_window.findChildByName("flat_controllers_container"));
         var_968 = IWindowContainer(_window.findChildByName("password_container"));
         var_1810 = ITextWindow(_window.findChildByName("basic_caption"));
         var_1809 = ITextWindow(_window.findChildByName("advanced_caption"));
         var_1424 = ITextWindow(_window.findChildByName("switch_view_text"));
         var_1424.procedure = onSwitchView;
         var_968.visible = false;
         if(!_inRoom)
         {
