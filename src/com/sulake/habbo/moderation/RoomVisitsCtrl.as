package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_2180:IWindowContainer;
      ...
      public function onRoomVisits(param1:RoomVisitsData) : void
      {
         ...
         onResizeTimer(null);
         var_52.visible = true;
         var_48.messageHandler.removeRoomVisitsListener(this);
      }
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_2180.clone());
         ...
         new OpenRoomTool(var_52,var_48,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
         ...
         new OpenRoomInSpectatorMode(var_48,_loc7_,param1.isPublic,param1.roomId);
         _loc7_.color = _loc4_;
      ...
      {
         var_2180 = IWindowContainer(var_48.getXmlWindow("roomvisits_row"));
         var_385 = new Timer(300,1);
         var_385.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_48.messageHandler.addRoomVisitsListener(this);
         var_48.connection.send(new GetRoomVisitsMessageComposer(_userId));
         var_52 = IFrameWindow(var_48.getXmlWindow("roomvisits_frame"));
