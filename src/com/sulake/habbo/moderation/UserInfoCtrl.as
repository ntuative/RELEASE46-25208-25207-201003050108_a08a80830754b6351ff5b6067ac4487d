package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_780:int = 31536000;
      
      private static const const_781:int = 86400;
      
      private static const const_778:int = 3600;
      
      private static const const_779:int = 60;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_779) + " mins ago";
         }
         ...
         {
            return Math.round(param1 / const_781) + " days ago";
         }
         return Math.round(param1 / const_780) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_48.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_48,WindowTracker.const_882,_data.userId),_callerFrame,var_1067,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_884.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_48.getXmlWindow("user_info"));
            var_884.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_48.windowTracker.show(new ModActionCtrl(var_48,_data.userId,_data.userName,var_1351),_callerFrame,var_1067,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_48.windowTracker.show(new RoomVisitsCtrl(var_48,_data.userId),_callerFrame,var_1067,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_48.windowTracker.show(new SendMsgsCtrl(var_48,_data.userId,_data.userName,var_1351),_callerFrame,var_1067,false,true);
      }
