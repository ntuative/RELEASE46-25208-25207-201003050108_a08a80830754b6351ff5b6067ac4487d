package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1530:IIssueBrowserView;
      
      private const const_1628:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1629:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1532:IIssueBrowserView;
      
      private const const_1632:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1627:String = "my_issues";
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            ...
            case const_1628:
               if(var_1530 == null)
               {
                  var_1530 = new OpenIssuesView(issueManager,this,var_232.container);
               }
               return var_1530;
            case const_1629:
               if(var_1531 == null)
