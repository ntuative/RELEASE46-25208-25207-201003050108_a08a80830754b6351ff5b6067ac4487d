package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1634:int = 3;
      
      public const const_1570:int = 2;
      ...
      public const const_1504:int = 1;
      
      private var var_197:Map;
      
      private var var_1999:String = "";
      
      private var var_1630:int = -1;
      
      private var var_1992:MarketplaceItemStats;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1504,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_1997 || param1.furniTypeId != var_1994)
         {
            return;
         }
         var_1992 = param1;
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = var_197.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1570,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function redeemSoldOffers() : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc1_:Array = var_197.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = var_197.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_407)
            {
               var_197.remove(_loc2_);
               _loc3_.dispose();
            }
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1996 = _loc3_.creditsWaiting;
         var_197 = new Map();
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            var_197.add(_loc4_.offerId,_loc6_);
         }
      ...
      {
         requestOffers(var_1995,var_1993,var_1999,var_1998);
      }
