package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1118:IProductData;
      ...
      {
         super();
         var_1120 = param1.productType;
         var_1121 = param1.furniClassId;
         var_944 = param1.extraParam;
         var_945 = param1.productCount;
         var_1119 = param1.expiration;
         var_1118 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_74:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_944);
               break;
