package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_840:MarketPlaceOfferData;
      
      private const const_1408:int = 1;
      
      private const const_1612:int = 40;
      ...
      private const const_1611:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_493)
         {
            ...
            var_493 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_493)
         {
            return;
         ...
         updateStatusDisplay(const_1409,_loc2_.length);
         if(!var_400)
         {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_580)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_493 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_493.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1408);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_399.length)
         {
            _loc4_ = 0;
         }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_839 >= var_580.length)
            {
               return true;
            }
            addListItem(var_580.getWithIndex(var_839));
            ++var_839;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_840.offerId);
            }
            return;
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_149)
         {
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_399));
            _loc7_.selection = 0;
         }
      }
