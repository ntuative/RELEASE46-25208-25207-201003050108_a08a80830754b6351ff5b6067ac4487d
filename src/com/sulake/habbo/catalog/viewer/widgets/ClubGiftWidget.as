package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function updateList() : void
      {
         ...
         for each(_loc6_ in _loc2_)
         {
            ...
            if(_loc5_)
            {
               ...
               var_580.add(_loc1_.offerId,_loc1_);
            }
         }
      }
      ...
      {
         if(!param1 || !param2 || !var_580 || !var_10)
         {
            return;
         }
         ...
         var _loc3_:Offer = var_580.getValue(param2.id) as Offer;
         if(!_loc3_)
         {
            return;
         }
