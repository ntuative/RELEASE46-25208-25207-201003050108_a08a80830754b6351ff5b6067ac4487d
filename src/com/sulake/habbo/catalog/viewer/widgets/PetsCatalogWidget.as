package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_371 >= var_289.length)
         {
            return "";
         }
         var petColor:IPetColor = var_289[var_371] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_532[var_1395] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var_371 = param1.index;
         if(var_371 < 0 || var_371 > var_289.length)
         {
            var_371 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_580.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_149,onTextWindowEvent);
         var_580 = new Map();
         ...
         if(page && false && page.viewer.catalog)
         {
            ...
            if(_loc10_ && _loc10_.avatarRenderManager && _loc10_.avatarRenderManager.petDataManager)
            {
               ...
               if(_loc11_)
               {
                  var_532 = _loc11_.breeds;
                  var_289 = _loc11_.colors;
                  if(var_289 == null)
                  {
                     var_289 = [];
                  }
         ...
         events.addEventListener(WidgetEvent.const_806,onApproveNameResult);
         _loc5_ = var_580.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_580.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_371 >= 0 && var_371 < var_289.length)
         {
            _loc7_ = var_289[var_371] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_532[var_1395] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_762,_loc3_.id,_loc2_,AvatarScaleType.const_51);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_284,AvatarAction.const_589);
