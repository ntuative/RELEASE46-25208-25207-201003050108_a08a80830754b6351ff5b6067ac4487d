package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_531[var_947] as Array;
      ...
      {
         var _loc2_:Offer = var_531[var_947][var_1691];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_439 || _loc1_.pricingModel == Offer.const_400)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_74 || _loc3_.productType == ProductTypeEnum.const_76)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(var_946.indexOf(_loc5_) == -1)
                        {
                           var_946.push(_loc5_);
                           var_531.push(new Array());
                        }
                        _loc6_ = var_946.indexOf(_loc5_);
                        (var_531[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
         }
         for each(_loc2_ in var_531)
         {
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_531)
         {
            if(var_1691 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1691] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_947 = var_921.getGridItemIndex(param1.view);
