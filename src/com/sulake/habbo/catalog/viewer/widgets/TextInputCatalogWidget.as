package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         var_1032 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1032 != null)
         {
            var_1032.addEventListener(WindowKeyboardEvent.const_608,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1032.text));
      }
   }
}
