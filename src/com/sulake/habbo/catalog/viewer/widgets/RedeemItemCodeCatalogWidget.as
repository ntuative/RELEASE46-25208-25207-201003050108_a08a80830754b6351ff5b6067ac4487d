package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_951 != null)
         {
            var_951.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_950 != null)
         {
            var_950.removeEventListener(WindowKeyboardEvent.const_132,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_951 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_951 != null)
         {
            var_951.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_950 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_950 != null)
         {
            var_950.addEventListener(WindowKeyboardEvent.const_132,windowKeyEventProcessor);
         }
      }
