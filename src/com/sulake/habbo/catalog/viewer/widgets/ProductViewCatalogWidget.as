package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1206:IScrollbarWindow;
      
      protected var var_1364:XML;
      
      private var var_1207:BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_559 != null)
         {
            var_559.visible = false;
            var_559.destroyGridItems();
         }
         if(var_1206 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1211.text = "${" + _loc3_.name + "}";
            var_1210.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1211.text = "${" + _loc2_.localizationId + "}";
            var_1210.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_451:
                  _loc4_ = var_1207.clone();
                  if(var_559 != null)
                  {
                     var_559.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_559,var_1206,var_1364);
                  }
                  break;
               case Offer.const_439:
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_196:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              _loc13_.setDirection(AvatarSetType.const_44,3);
                              _loc13_.initActionAppends();
                              _loc13_.appendAction(AvatarAction.const_284,AvatarAction.const_733);
                              _loc13_.appendAction(AvatarAction.const_498,_loc6_.productClassId);
      ...
      {
         var_1211 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1210 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_84 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1461 = new Point(var_84.x,var_84.y);
         var_559 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1206 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_559 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         var_1364 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         var_1207 = _loc2_.content as BitmapData;
