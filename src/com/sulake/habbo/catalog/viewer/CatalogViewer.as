package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1462:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_665 != null)
         {
            _container.removeChild(var_665.window);
            var_665.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1462);
         var_665 = _loc5_;
      ...
      {
         return var_665.dispatchWidgetEvent(param1);
      }
