package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1384:String = "ctlg_";
      ...
      private var var_1165:EventDispatcher;
      
      private var _pageId:int;
      
      private var var_764:ICatalogViewer;
      ...
      {
         var _loc2_:String = const_1384 + param1;
         ...
         var_1365 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1365) as IWindowContainer;
         if(_window == null)
         {
      ...
      {
         return _localization.hasLinks(var_785);
      }
      ...
      private function createWidgets() : void
      {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1165;
            _loc2_.init();
         }
         var_1165.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1165.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_785);
      }
