package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1480)
         {
            case RecyclerStatusMessageEvent.const_1165:
               ...
               break;
            case RecyclerStatusMessageEvent.const_888:
               if(_view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1302:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1480 != RecyclerStatusMessageEvent.const_888;
      }
      ...
      {
         return active && var_257 == const_341;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_986:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1317:
