package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_402:ICatalogNavigator;
      ...
      private var var_2056:GiftWrappingConfiguration;
      ...
      private var var_1044:ClubGiftController;
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_155.credits = _loc3_.balance;
         updatePurse();
         if(!var_2054 && var_498 != null)
         {
            var_498.playSound(HabboSoundTypesEnum.const_850);
         }
         var_2054 = false;
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_87 == null)
         {
            return;
         }
         var_87.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_89:
               var_1289 = param1.session.isPrivateRoom;
               if(var_87 != null)
               {
                  var_87.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_101:
               ...
               if(var_87 != null)
               {
                  var_87.setRoomSessionActive(false);
               }
         }
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         var_87.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_2056 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(false)
         {
            ...
            if(var_87 != null && getCurrentLayoutCode() == "recycler")
            {
               var_87.activate();
            }
         }
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_192,false);
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_1044.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_402 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      {
         var_87 = new RecyclerLogic(this,_windowManager);
         getRecyclerPrizes();
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_155.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_155.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         updatePurse();
      ...
      private function createClubGiftController() : void
      {
         if(var_1044 == null)
         {
            var_1044 = new ClubGiftController(this);
         }
      }
      ...
      {
         var_190.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_109,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_402.buildCatalogIndex(_loc2_);
         if(var_1043 != "")
         {
            var_402.openPage(var_1043);
            var_1043 = "";
         }
         else
         {
            var_402.openFrontPage();
         }
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         var_87.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_155.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_155.pixels));
         _localization.registerParameter("catalog.purse.clubdays","days",String(var_155.clubDays));
         _localization.registerParameter("catalog.purse.clubdays","months",String(var_155.clubPeriods));
         if(false)
         {
            return;
         }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_155.pixels = _loc2_.amount;
         updatePurse();
         if(!var_2055 && var_498 != null)
         {
            var_498.playSound(HabboSoundTypesEnum.const_895);
         }
         var_2055 = false;
      }
