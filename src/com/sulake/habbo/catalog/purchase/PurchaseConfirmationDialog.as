package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1411:uint = 4.294967295E9;
      
      private const const_1410:uint = 4.293848814E9;
      
      private var var_1264:int;
      
      private const const_1610:uint = 4.291613146E9;
      ...
      private function checkboxHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_723:
               showSelectors(false);
               break;
            case WindowEvent.const_698:
               showSelectors(true);
         }
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_838;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_838,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1410) : uint(const_1411);
      }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = var_1382;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = _catalog.getFurnitureData(_loc6_,ProductTypeEnum.const_76);
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_665,var_76,var_1033);
               dispose();
               break;
            case "cancel_button":
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_838);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_578[var_199]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_579[var_200]);
         _catalog.purchaseProductAsGift(var_665,var_76,var_1033,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_47:
               ...
               break;
            case WindowKeyboardEvent.const_608:
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc6_.productType)
            {
               ...
               case ProductTypeEnum.const_196:
                  ...
                  break;
               case ProductTypeEnum.const_418:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1382 = _loc1_.stuffTypes;
            var_578 = _loc1_.boxTypes;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_492 == null)
         {
            var_492 = createWindow("suggestion_list_item") as IWindowContainer;
            var_492.procedure = suggestionsEventHandler;
         }
         if(var_227 == null || var_492 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_227.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_492.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
