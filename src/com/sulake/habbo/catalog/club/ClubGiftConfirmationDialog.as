package com.sulake.habbo.catalog.club
{
   ...
   public class ClubGiftConfirmationDialog
   {
      ...
      {
         if(!param1 || !param2 || !var_10 || !var_76)
         {
            return;
         }
         ...
         {
            case "select_button":
               var_10.confirmSelection(var_76.localizationId);
               break;
            case "header_button_close":
            case "cancel_button":
               var_10.closeConfirmation();
         }
      }
      ...
      public function showConfirmation() : void
      {
         ...
         var_76.productContainer.initProductIcon(var_10.roomEngine);
      }
