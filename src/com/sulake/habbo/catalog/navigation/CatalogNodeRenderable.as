package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1044:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1421:XML;
      
      private static var var_1420:XML;
      ...
      private var var_1419:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1419 == 4294967295)
            {
               var_1419 = _loc1_.color;
            }
            _loc1_.color = const_1044;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1348;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1421) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_47 = navigator.catalog.windowManager.buildFromXML(var_1420) as IItemListWindow;
         if(var_47 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1197;
            }
         }
      }
