package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_835:IAvatarRenderManager;
      
      private var var_190:IHabboToolbar;
      
      private var var_387:FriendListTabs;
      ...
      private var var_894:FriendRequests;
      
      private var var_1593:int;
      
      var var_13:FriendCategories;
      
      private var var_2204:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_895:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_2204 = new FriendListLookAndFeel();
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_894.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_894.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_387.findTab(FriendListTab.const_79).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_894 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_13.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_13.addCategory(new FriendCategory(FriendCategory.const_799,getText("friendlist.friends")));
         var_13.addCategory(new FriendCategory(FriendCategory.const_474,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_13.addFriend(new Friend(_loc4_));
         }
         var_387 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_514)
         {
         ...
         getBuddyRequests();
         registerListeners();
         var_190.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_109,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         if(var_835)
         {
            var_835.release(new IIDAvatarRenderManager());
            var_835 = null;
         }
         if(var_895)
         {
            var_895.release(new IIDHabboNotifications());
            var_895 = null;
         }
         if(var_190)
         {
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_387.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_321));
            }
            else
            {
               switch(_loc1_.id)
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_159,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_894.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      {
         var _loc2_:FriendListTab = var_387.findTab(FriendListTab.const_79);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_835.createAvatarImage(param1,AvatarScaleType.const_99);
         return _loc2_.getCroppedImage(AvatarSetType.const_44);
      }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_894.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_387.findTab(FriendListTab.const_79);
      ...
      {
         var_895 = param2 as IHabboNotifications;
