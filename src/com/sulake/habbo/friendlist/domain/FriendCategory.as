package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_799:int = 0;
      
      public static const const_474:int = -1;
      
      public static const const_280:int = 100;
      ...
      {
         return Math.ceil(this.var_214.length / const_280);
      }
      ...
      {
         if(this.var_786 >= this.getPageCount())
         {
            this.var_786 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_786 + 1) * const_280,this.var_214.length);
      }
