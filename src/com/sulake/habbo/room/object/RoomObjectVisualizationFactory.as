package com.sulake.habbo.room.object
{
   ...
   public class RoomObjectVisualizationFactory extends Component implements IRoomObjectVisualizationFactory
   {
      ...
      private var var_911:IAvatarRenderManager = null;
      ...
      override public function dispose() : void
      {
         ...
         if(var_521 != null)
         {
            ...
            {
               _loc1_ = var_521.getWithIndex(_loc2_) as IRoomObjectVisualizationData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      private function avatarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_911 = param2 as IAvatarRenderManager;
      }
      ...
      public function createRoomObjectVisualization(param1:String) : IRoomObjectGraphicVisualization
      {
         ...
         switch(param1)
         {
            ...
            case RoomObjectVisualizationEnum.const_258:
               ...
               break;
            case RoomObjectVisualizationEnum.const_998:
            ...
            case RoomObjectVisualizationEnum.const_230:
               ...
               break;
            case RoomObjectVisualizationEnum.const_790:
               _loc2_ = FurnitureQueueTileVisualization;
               break;
            case RoomObjectVisualizationEnum.const_800:
               _loc2_ = FurniturePartyBeamerVisualization;
               break;
            case RoomObjectVisualizationEnum.const_1238:
               _loc2_ = FurnitureCuboidVisualization;
               break;
            case RoomObjectVisualizationEnum.const_808:
               _loc2_ = FurnitureGiftWrappedVisualization;
               break;
            case RoomObjectVisualizationEnum.const_228:
      ...
      public function getRoomObjectVisualizationData(param1:String, param2:String, param3:XML) : IRoomObjectVisualizationData
      {
         ...
         var _loc8_:* = null;
         var _loc4_:* = null;
         _loc4_ = var_521.getValue(param1) as IRoomObjectVisualizationData;
         if(_loc4_ != null)
         {
            return _loc4_;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc6_ is AvatarVisualizationData)
            {
               ...
               _loc7_.avatarRenderer = var_911;
            }
            else if(_loc6_ is PetVisualizationData)
            {
               _loc8_ = _loc4_ as PetVisualizationData;
               _loc8_.avatarRenderer = var_911;
            }
            if(var_2234)
            {
               var_521.add(param1,_loc6_);
            }
            return _loc6_;
         }
         return null;
