package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1516:int = 1500;
      
      private var var_1514:int = 255;
      
      private var var_1515:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_500:
                  _loc2_.setString(RoomObjectVariableEnum.const_680,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_710:
                  _loc2_.setString(RoomObjectVariableEnum.const_559,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_571:
                  _loc2_.setString(RoomObjectVariableEnum.const_632,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_384:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_209)
                  {
                     _loc8_ = "null";
                  }
                  var_409.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_719:
                  _loc7_ = var_409.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_409.getXML();
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_946,int(_loc5_.bgOnly));
            var_1293 = _color;
            var_1514 = var_1297;
            var_1046 = _loc11_;
            var_1515 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_868,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_605,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_79.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_96,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1226,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1288,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1326,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_96,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_138)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_143 || _loc13_ == RoomPlaneData.const_252)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_855)
         {
            ...
            else
            {
               ...
               _loc9_ = var_1293 & 255;
               _loc10_ = var_1046 >> 16 & 255;
               _loc11_ = var_1046 >> 8 & 255;
               _loc12_ = var_1046 & 255;
               _loc13_ = (_loc2_ - var_855) / var_1516;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1514 + (var_1515 - var_1514) * _loc13_;
               _color = _loc3_;
               var_1297 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_605,_loc3_);
         }
      }
   }
}
