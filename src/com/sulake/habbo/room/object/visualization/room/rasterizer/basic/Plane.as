package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      private var var_723:PlaneVisualization = null;
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_723 = var_423.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_723 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_423 != null)
         {
            _loc1_ = null;
            _loc2_ = 0;
            while(_loc2_ < var_423.length)
            {
               _loc1_ = var_423.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
