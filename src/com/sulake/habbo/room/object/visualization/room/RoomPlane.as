package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_248:int = 1;
      ...
      private var var_689:IPlaneRasterizer = null;
      ...
      private var var_543:PlaneMaskManager = null;
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_248 || _type == const_182))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_847 || false && false && !var_154 || var_543 == null)
         {
            return;
         }
         ...
         if(var_154)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(var_497);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < var_201.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc12_ = _loc3_.type;
                  var_543.updateMask(var_58,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  var_690.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < var_270.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  var_1042.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            var_154 = false;
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         if(var_689 != null)
         {
            return var_689.getTextureIdentifier(param1,normal);
         }
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(_type == const_248 || _type == const_182)
         {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         if(true)
         {
            while(_loc1_ < var_201.length)
            {
               ...
               {
                  _loc6_ = false;
                  while(_loc2_ < var_690.length)
                  {
                     _loc7_ = var_690[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
      ...
      public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : Boolean
      {
         ...
         if(param3)
         {
            ...
            _loc5_ = 0;
            while(_loc5_ < var_1242.length)
            {
               _loc4_ = Number(Vector3d.cosAngle(param1.directionAxis,var_1242[_loc5_]));
               if(_loc4_ > -0.001)
               {
                  if(_isVisible)
                  {
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            if(var_689 != null)
            {
               _loc3_ = var_689.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1513,var_2050,var_2051,var_2053,var_2052,param2);
               if(_loc3_ != null)
               {
