package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1461:int = 16777216;
      ...
      private var var_2343:int = 5;
      
      private var var_1557:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1557 * param2);
      }
      ...
      {
         var _loc1_:int = var_2342 * var_1333 + var_2343;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
