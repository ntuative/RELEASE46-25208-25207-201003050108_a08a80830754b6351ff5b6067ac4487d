package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1170:int = const_309;
      ...
      public static const const_221:int = 4;
      
      public static const const_575:int = 6;
      
      public static const const_244:int = const_100;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1, param5:Number = 1, param6:Number = -1, param7:Number = 1)
      {
         ...
         var_1654 = param6;
         var_1655 = param7;
         var_775 = new Vector3d();
         if(var_1414 == const_575)
         {
            var_1147 = false;
         }
      }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1413 == const_100)
         {
            _loc5_ = new Rectangle(0,0,var_26.width,var_447);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_447,var_26.width,var_447);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_26 != null)
            {
               if(var_26.width == param2 && var_26.height == param3 && Vector3d.isEqual(var_775,param4))
               {
                  if(param1 != null)
                  {
