package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1385:Number = Math.sqrt(0.5);
       
      
      protected var _direction:int;
      
      protected var var_2259:int = -1;
      ...
      protected var var_1494:String = null;
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1494 != null && var_1494.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null && _loc8_.asset != null)
               {
                  ...
                  if(_loc5_ < spriteCount - 1)
                  {
                     ...
                     _loc7_.color = getSpriteColor(_loc5_,var_2259,param1);
      ...
      {
         var _loc3_:int = 0;
         if(var_1881 != param1 || var_1883 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
               var_552[_loc3_] = "";
               var_553[_loc3_] = false;
               _loc3_--;
            }
            var_1881 = param1;
            var_1883 = param2;
      ...
      {
         var _loc3_:int = 0;
         if(var_1882 != param1 || var_1884 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2259 = _loc3_.getNumber(RoomObjectVariableEnum.const_190);
            ...
            var_1494 = _loc3_.getString(RoomObjectVariableEnum.const_313);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_282 != _loc3_.getUpdateID() || param1 != var_208 || param2 != var_2260)
         {
