package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1056:Number = 30;
      ...
      private var var_664:Vector3d;
      
      private var var_1229:Number;
      ...
      {
         var_664 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1229 = param3;
         var_1901 = param4 * 0 * 2 / 360;
         var_1459 = param5 * 0 * 2 / 360;
         _height = param6;
         var_803 = 0;
      }
      ...
      {
         var _loc3_:Number = var_1229 * Math.cos(var_803 + var_1459);
         var _loc4_:Number = var_1229 * Math.sin(var_803 + var_1459);
         var _loc5_:Number = _height;
         var_664.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_664.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_664.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_664.add(param1);
         }
