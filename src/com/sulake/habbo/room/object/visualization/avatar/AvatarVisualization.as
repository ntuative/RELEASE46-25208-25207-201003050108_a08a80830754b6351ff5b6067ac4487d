package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1403:int = 0;
      
      private var var_561:String;
      
      private var var_620:int = 0;
      
      private const const_1606:int = 1;
      ...
      private const const_1607:int = 2;
      
      private var var_808:AvatarVisualizationData = null;
      
      private const const_1066:int = 3;
      ...
      {
         var_808 = param1 as AvatarVisualizationData;
         createSprites(const_1066);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_403.getValue(_loc5_) as IAvatarImage;
         var _loc7_:String = _loc4_.getString(RoomObjectVariableEnum.const_162);
         var _loc8_:Number = new Date().valueOf();
         var _loc9_:Boolean = false;
         var _loc10_:Number = _loc4_.getNumber(RoomObjectVariableEnum.AVATAR_TALK_TIMESTAMP);
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_564);
         ...
         var _loc14_:Number = _loc8_ - var_1218;
         ...
         var _loc16_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_307);
         if(_loc16_ > 0)
         {
         ...
         var _loc20_:Boolean = var_282 != _loc3_.getUpdateID() || var_208 != param1.scale || var_161 != _loc4_.getUpdateID();
         var _loc21_:Boolean = _isAnimating || var_472 > 0;
         if(_loc20_ || _loc21_)
         {
            increaseUpdateId();
            --var_472;
            ...
            if(var_561 != _loc7_)
            {
               for each(_loc49_ in var_403.getKeys())
               {
                  var_403.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               _loc6_ = var_808.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
               var_403.remove(_loc5_);
               var_403.add(_loc5_,_loc6_);
               var_561 = _loc7_;
            }
            ...
            if(isNaN(_loc25_) || _loc4_.getString(RoomObjectVariableEnum.const_243) == "float")
            {
               _loc25_ = _loc24_;
            }
            else
            ...
            _loc6_.setDirectionAngle(AvatarSetType.const_44,_loc25_);
            _loc6_.initActionAppends();
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_243);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_627);
            _loc6_.appendAction(AvatarAction.const_590,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_364);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_51)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_380);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_284,AvatarAction.const_1185[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_826);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_953,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_898);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_956);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_993,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_515);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_708);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_867,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_856);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_842,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_415);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_383) > 0;
            if(_loc35_ || _loc13_)
            {
            ...
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_464);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_786);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_498,_loc36_);
            }
            ...
            _loc43_ = getSprite(const_1607);
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_1011))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_808.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
            ...
            var_809.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_809)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_403 != null)
         {
            _loc1_ = var_403.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_403.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
