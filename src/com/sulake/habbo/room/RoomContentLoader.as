package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_1095:String = const_345;
      ...
      private var var_1047:IEventDispatcher = null;
      
      private var var_1294:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_502 = [];
         var_500 = [];
         var_2067 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_106 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      {
         if(var_174 != null && var_174.hasWorldType(const_277 + param1))
         {
            return var_174.type;
         }
         return param1;
      ...
      public function dispose() : void
      {
         ...
         if(var_405 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_405.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         if(var_343 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_343.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_405.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_588.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_405.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_345,const_492,ROOM_CONTENT,const_774,const_775];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2067.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_166 && _loc5_ != RoomObjectLogicEnum.const_106)
         {
            _loc6_ = "@shadow";
      ...
      {
         if(var_587.getValue(param1) != null)
         {
            return var_587.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1250);
               return;
            }
         }
      }
      ...
      public function method_2(param1:int, param2:String = null) : String
      {
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_456,_loc5_);
         }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(var_174 != null && (var_174.type == param1 || var_174.hasWorldType(param1)))
         {
            return RoomObjectCategoryEnum.const_59;
         }
         if(param1 == "room")
         {
            return RoomObjectCategoryEnum.const_59;
      ...
      private function continueInitilization() : void
      {
         if(var_2071)
         {
            ...
            if(var_1047 != null)
            {
               var_1047.dispatchEvent(new Event(const_676));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_174 != null)
         {
            return var_174.getWorldHeightScale(const_277 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_1047 = param1;
            var_2065 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_2070 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_2066 = param2.getKey("public.room.dynamic.download.url","");
            var_2068 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_32 = const_773;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_343.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(var_406 != null)
         {
            var_406.remove(param2);
            var_406.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_166 && _loc5_ != RoomObjectVisualizationEnum.const_106)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_394.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_277 + param1) == RoomObjectCategoryEnum.const_59)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1294.getValue(param1) != null)
         {
            var_174 = var_1294.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_438,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_174 != null)
         {
            return var_174.getWorldScale(const_277 + param1);
         }
         return 32;
      }
