package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_485:String = "room";
      
      private static const const_741:int = -2;
      ...
      private static const const_1030:String = "tile_cursor";
      
      private static const const_275:int = -1;
       
      
      private var var_394:IRoomObjectVisualizationFactory = null;
      
      private var var_442:Boolean = false;
      
      private var var_9:RoomContentLoader = null;
      
      private var var_288:Map = null;
      
      private var _connection:IConnection = null;
      
      private var _adManager:IAdManager = null;
      
      private var var_530:NumberBank;
      ...
      private var var_627:RoomMessageHandler = null;
      
      private var var_626:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_287 = new Map();
         var_530 = new NumberBank(1000);
         var_942 = new Map();
         var_288 = new Map();
         var_65 = new RoomObjectEventHandler(this);
         var_627 = new RoomMessageHandler(this);
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_287.length; _loc2_++)
         {
            _loc3_ = var_287.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_505) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_502) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_687) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_593) + 0.5;
      ...
      override public function dispose() : void
      {
         ...
         if(var_394 != null)
         {
            var_394.release(new IIDRoomObjectVisualizationFactory());
            var_394 = null;
         }
         if(var_40 != null)
         {
         ...
         if(var_626 != null)
         {
            var_626.release(new IIDRoomRendererFactory());
            var_626 = null;
         }
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_287.length)
            {
               _loc2_ = var_287.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_626.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_861;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_553);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_584);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_551);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1018);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1014);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_959) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_942);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_384,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_719,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_716,var_108,var_109,param2,param3));
            }
         }
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_288.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_288.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_500,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_710,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_571,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_40 != null)
         {
            var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.const_29);
            ...
            var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.const_234);
            var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.const_59);
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_190,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_325,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_313,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_812,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_855,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_843,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_255,param1,param2,param3,RoomObjectCategoryEnum.const_29));
         }
         return true;
      }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_557,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(var_25 == null || var_394 == null || var_40 == null || var_626 == null || _communication == null || var_97 == null || !var_1656)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_275,RoomObjectCategoryEnum.const_59);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1314,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_742,RoomObjectCategoryEnum.const_234);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_108,var_109,var_1116);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_108,var_109,var_1116);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_394 = param2 as IRoomObjectVisualizationFactory;
         if(var_9 != null)
         {
            var_9.visualizationFactory = var_394;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_25 != null)
         {
            if(false)
            {
               var_25.events.addEventListener(RoomObjectMouseEvent.const_223,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMouseEvent.const_433,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMouseEvent.const_447,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectStateChangeEvent.const_269,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectStateChangeEvent.const_550,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_119,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_118,roomObjectEventHandler);
               ...
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_104,roomObjectEventHandler);
               ...
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_90,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_445,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_454,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_436,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_458,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_443,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_SOUND_MACHINE_START,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_393,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_413,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_350,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_457,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectDimmerStateUpdateEvent.DIMMER_STATE,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMoveEvent.const_368,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMoveEvent.const_440,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_250,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_365,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_323,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_292,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomActionEvent.const_394,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomActionEvent.const_1001,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomActionEvent.const_410,roomObjectEventHandler);
               var_25.events.addEventListener(AvatarWalkWarpingWarningEvent.const_477,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_531) != 0)
         {
            return false;
         }
         if(var_65 != null)
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         if(param1)
         {
            ...
            {
               _loc3_ = var_288.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_255,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_28:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_190));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_483);
                     break;
                  case RoomObjectCategoryEnum.const_34:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_162);
               }
            }
         }
      ...
      private function method_2(param1:int, param2:String = null) : String
      {
         if(var_9 != null)
         {
            return var_9.method_2(param1,param2);
         }
         return "";
      }
      ...
      {
         var _loc9_:String = method_2(param4,param8);
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_325,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_313,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_861,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_255,param1,param2,param3,RoomObjectCategoryEnum.const_28));
         }
         return true;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _adManager.events.addEventListener(AdEvent.const_424,showRoomAd);
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = var_287.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_626 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_442 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_40.getRoom(const_484);
         if(_loc10_ == null)
         {
            _loc10_ = var_40.createRoom(const_484,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_530.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_29:
            case RoomObjectCategoryEnum.const_28:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_190,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_483,param8);
               break;
            case RoomObjectCategoryEnum.const_34:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_162,param2);
               break;
            case RoomObjectCategoryEnum.const_59:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_138,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     _loc21_.addPlane(RoomPlaneData.const_143,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_143,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_252,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_680,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_559,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_632,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_384,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_942.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_952,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_530.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      public function getWallItemImage(param1:int, param2:IVector3d, param3:int, param4:IGetImageListener, param5:String = null, param6:uint = 0) : ImageResult
      {
         ...
         if(var_9 != null)
         {
            _loc7_ = var_9.method_2(param1,param5);
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_741,RoomObjectCategoryEnum.const_234);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1386 - _loc12_.width / 2;
               _loc11_.y = var_1385 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_408,var_108,var_109,-1,RoomObjectCategoryEnum.const_216));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_65 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_275,const_485);
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         else if(var_9 != null)
         {
            ...
            {
               _loc8_ = var_9.method_2(param1,param4);
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_108,var_109,var_1116);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1386 - _loc6_.data.width / 2;
               _loc11_.y = var_1385 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_9 != null)
         {
            ...
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_282,param1.image,true);
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_820,param1.adWarningL,true);
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_947,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_813,RoomObjectVariableEnum.const_282,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_287.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_287.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_40.getRoom(const_484);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_952);
               ...
               var_530.freeNumber(_loc10_ - 1);
               _loc13_ = var_942.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_108,var_109,const_275,RoomObjectCategoryEnum.const_59,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         var _loc8_:int = _loc8_ = RoomObjectCategoryEnum.const_59;
         var _loc9_:* = null;
         var _loc10_:* = 1;
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc7_.setNumber(RoomVariableEnum.const_531,1,true);
            _loc13_ = parseInt(var_97.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_870,_loc13_,true);
            if(var_9 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_275,const_485,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_531,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_553,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_505,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_687,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_502,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_593,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_860,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_500,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_710,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_571,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_384,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_209);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_584,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_551,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_584,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_551,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1018,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1014,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_741,const_1030,RoomObjectCategoryEnum.const_234);
         _loc7_.createRoomObject(const_742,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_234);
         return _loc7_;
      }
