package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1399:int = 0;
      ...
      private var var_1827:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","25208-25207-201003050040");
         var_190 = param5;
         var_102 = new Map();
         var_102.add(HabboHelpViewEnum.const_1379,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_130,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_355,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_235,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_197,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_646,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_320,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_527,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_199,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         var_102.add(HabboHelpViewEnum.CALL_FOR_HELP_HAS_ABUSIVE_ITEM,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_abusive")));
         var_102.add(HabboHelpViewEnum.const_809,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_653,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_249 == HabboHelpViewEnum.const_130 || false)
         {
            return;
         }
         if(var_380 == null)
      ...
      {
         return var_102.getValue(var_249);
      }
      ...
      public function dispose() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:Array = var_102.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = var_102.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      {
         var_1828 = param1;
         var _loc2_:IHelpViewController = var_102.getValue(HabboHelpViewEnum.const_130) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_906:
               showUI(HabboHelpViewEnum.const_809);
               break;
            case CallForHelpResultEnum.const_915:
      ...
      {
         var _loc3_:* = null;
         if(var_249 == HabboHelpViewEnum.const_130)
         {
            return;
         }
         if(true)
         {
            ...
            var_546.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_546[1],var_546[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_546[0],var_546[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1431;
         _window.width = _loc1_.width + var_1430;
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = var_102.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_29.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_666));
      }
