package com.sulake.habbo.help.help
{
   ...
   public class FaqBrowseEntry extends SearchViewController implements IHelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         if(true)
         {
            main.sendMessage(new GetFaqTextMessageComposer(var_237.questionId));
            return;
         }
         var _loc3_:FaqCategory = var_237.category;
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            _loc4_.text = var_237.questionText;
         }
         _loc4_ = container.findChildByTag("faq_answer_text") as ITextWindow;
         if(_loc4_ != null)
         {
            _loc4_.htmlText = hackHTML(var_237.answerText);
         }
         if(_loc3_ != null)
         {
      ...
      override public function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "help_faq_back":
               if(var_237 != null)
               {
                  _loc3_ = var_237.category;
                  main.showUI(HabboHelpViewEnum.const_235);
                  main.tellUI(HabboHelpViewEnum.const_235,_loc3_);
               }
               break;
      ...
      private function getNextItem() : FaqItem
      {
         ...
         if(_loc1_ == null || var_237 == null)
         {
            return null;
         }
         var _loc2_:FaqCategory = var_237.category;
         if(_loc2_ == null)
         {
            return null;
         }
