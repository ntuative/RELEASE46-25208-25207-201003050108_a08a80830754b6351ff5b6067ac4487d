package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_687:FaqCategory;
      ...
      {
         super();
         var_687 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_688 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_135 = new Map();
      }
      ...
      {
         var _loc4_:* = null;
         if(var_687.hasItem(param1))
         {
            var_687.getItem(param1).answerText = param2;
         }
