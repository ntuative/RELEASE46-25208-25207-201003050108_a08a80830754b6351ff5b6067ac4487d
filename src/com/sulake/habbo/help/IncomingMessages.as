package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_29.tellUI(HabboHelpViewEnum.const_197,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_29.tellUI(HabboHelpViewEnum.const_235,_loc6_);
      }
      ...
      {
         var_29.showUI(HabboHelpViewEnum.const_320);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_29.showUI(HabboHelpViewEnum.const_355);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_29.showUI(HabboHelpViewEnum.const_646);
         var_29.tellUI(HabboHelpViewEnum.const_646,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_395)
            {
         ...
         var_29.tellUI(HabboHelpViewEnum.const_653);
      }
