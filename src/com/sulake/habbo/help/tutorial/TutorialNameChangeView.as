package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_1521:uint = 13232628;
      
      private static var var_2090:uint = 11129827;
      ...
      private var var_865:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         var_48.localization.registerParameter("help.tutorial.name.available","name",var_411);
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "button_usecurrent":
                  var_411 = var_48.help.ownUserName;
                  showConfirmationView(true);
                  break;
               case "button_name_check":
                  if(_loc3_.text.length < 1)
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            var_48.localization.registerParameter("help.tutorial.name.confirmation","name",var_411);
         }
         if(var_272 == null)
         {
            var_272 = var_48.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_272 == null)
            {
               return;
            }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1583 || param1 == ChangeUserNameResultMessageEvent.var_1582)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         var_865 = new NameSuggestionListRenderer(var_48);
         var _loc6_:int = var_865.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1521;
