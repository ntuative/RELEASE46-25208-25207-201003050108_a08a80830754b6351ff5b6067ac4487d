package com.sulake.habbo.help.tutorial
{
   ...
   public class NameSuggestionListRenderer
   {
      ...
      private const const_1623:int = 5;
      ...
      {
         var _loc2_:ITextWindow = var_48.buildXmlWindow("tutorial_name_suggestion_item") as ITextWindow;
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         {
            _offsetX = 0;
            var_861 += param1.height + const_1623;
            return fit(param1);
         }
         param1.offset(_offsetX,var_861);
         _offsetX += param1.width + const_1624;
         return true;
      }
