package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_787:BitmapData = null;
      ...
      private var var_788:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_424,0,0,_loc4_,var_1438,var_788,var_787));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1852 = int(_config.getKey("interstitial.interval","30000"));
         var_1853 = int(_config.getKey("interstitial.show.time","5000"));
         var_1439 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1168 = _loc2_.imageUrl;
         var_1438 = _loc2_.clickUrl;
         if(var_1168 != "" && var_1438 != "")
         {
            _loc3_ = var_1168;
            ...
            _loc4_ = new URLRequest(var_1168);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1169 = _loc2_.imageUrl;
         var_1851 = _loc2_.clickUrl;
         var_649 = getTimer();
         if(var_1169 != "")
         {
            _loc3_ = var_1169;
            ...
            if(var_215 == null)
            {
               var_215 = new Timer(var_1853,1);
               var_215.addEventListener(TimerEvent.TIMER_COMPLETE,interstitialTimerComplete);
            }
            if(false)
            {
               var_215.reset();
            ...
            var_215.start();
            _loc4_ = new URLRequest(var_1169);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_352,0,0,param1.bitmapData,var_1851));
            var_649 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_787 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      
      public function showInterstitial() : Boolean
      {
         if(var_215 != null && false)
         {
            var_215.reset();
            return false;
         }
         ...
         if(var_1439 > 0 && var_1440 >= var_1439)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_649;
         if(_loc1_ > var_1852)
         {
            ++var_1440;
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_467));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_788 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
