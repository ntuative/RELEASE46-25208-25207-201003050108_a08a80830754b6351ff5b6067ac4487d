package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1040:uint = 1;
      ...
      private var var_2352:uint = 0;
      
      private var var_1140:ProfilerAgentTask;
      
      private var var_1142:ProfilerOutput;
      
      private var var_635:IWindowRenderer;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_635 = new WindowRenderer(_loc4_);
         var_212 = new Array(const_340);
         var _loc6_:int = 0;
         while(_loc6_ < const_340)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_635,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_212[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_240 = var_212[const_1040];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_240.getMouseCursor().defineCustomCursorType(MouseCursorType.const_311,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_240.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1364,_loc7_);
      }
      ...
      {
         return var_212[param1].getDesktopWindow().getChildAt(var_240.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1142 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1142 = new ProfilerOutput(_loc3_,this,var_635);
               var_1143 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1143);
               var_1140 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1140);
               var_959 = true;
            }
         }
      }
      ...
      {
         return var_240.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_1358.length > 0)
         {
            WindowContext.var_1358.flush();
         }
      ...
      {
         var _loc3_:Dictionary = var_372[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_372[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_240.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1277,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1187,param2.name + ": " + param2.toString());
            }
