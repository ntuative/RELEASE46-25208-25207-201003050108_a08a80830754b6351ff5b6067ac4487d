package com.sulake.habbo.window.utils
{
   ...
   public class ProfilerOutput implements IDisposable
   {
      ...
      public function ProfilerOutput(param1:IProfiler, param2:IHabboWindowManager, param3:IWindowRenderer)
      {
         ...
         var_412.addStopEventListener(refresh);
      ...
      {
         var _loc2_:Array = var_412.getProfilerAgentsInArray();
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            _window.dispose();
            _window = null;
            var_412.removeStopEventListener(refresh);
            var_412 = null;
            _windowManager = null;
            var_635 = null;
            _disposed = true;
