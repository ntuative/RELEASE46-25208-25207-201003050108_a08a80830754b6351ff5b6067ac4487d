package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_577:Number = 64;
      
      public static const const_896:Number = 32;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:* = 0;
         var_222.assign(param1);
         if(var_222.x != _loc2_ || var_222.y != _loc3_ || var_222.z != _loc4_)
         {
            ++var_77;
         }
      ...
      {
         if(var_389 != param1 * var_1477)
         {
            var_389 = param1 * var_1477;
            ++var_77;
         }
      }
      ...
      {
         if(var_391 != param1 * var_1476)
         {
            var_391 = param1 * var_1476;
            ++var_77;
         }
      }
      ...
      {
         if(var_392 != param1 * var_1478)
         {
            var_392 = param1 * var_1478;
            ++var_77;
         }
      }
      ...
      {
         return new Vector3d(var_222.x,var_222.y,var_222.z);
      }
      ...
      {
         return new Vector3d(0 * var_391,0 * var_392,0 * var_389);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_391,0 * var_392,0 * var_389);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_86;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_391,param2.y * var_392,param2.z * var_389);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_391,param3.y * var_392,param3.z * var_389);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_391,param4.y * var_392,param4.z * var_389);
