package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      private var var_140:IRoomRendererBase;
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(var_236.getValue(_loc2_) != null)
         {
            _loc3_ = var_236.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      public function dispose() : void
      {
         ...
         if(var_236 != null)
         {
            ...
            {
               _loc3_ = var_236.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(var_140)
               {
                  var_140.removeRoomObject(_loc4_.getInstanceId());
               }
      ...
      public function setNumber(param1:String, param2:Number, param3:Boolean = false) : void
      {
         ...
         if(var_482[param1] != param2)
         {
            var_482[param1] = param2;
         }
      }
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         if(var_236.getValue(_loc2_) != null)
         {
            return var_236.getValue(_loc2_) as IRoomObjectManager;
         }
         if(_container == null)
         {
            return null;
      ...
      {
         return var_236.getKeys();
      }
      
      protected function getObjectManager(param1:int) : IRoomObjectManager
      {
         return var_236.getValue(String(param1)) as IRoomObjectManager;
      }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(var_140)
                  {
                     var_140.removeRoomObject(_loc6_);
                  }
               }
               _loc4_++;
            }
