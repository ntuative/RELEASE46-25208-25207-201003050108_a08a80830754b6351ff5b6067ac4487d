package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_478:IRoomObjectFactory = null;
      
      private var var_1563:int;
      
      private var var_2368:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_479 = [];
         var_480 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_332,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_456,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_545,onContentLoaded);
      }
      
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         var _loc5_:* = null;
         if(var_32 == const_1200)
         {
            if(var_826 != null)
            {
               return false;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = var_394.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = var_394.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = var_478.createRoomObjectLogic(_loc11_);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_478 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = var_480.indexOf(param1);
         if(_loc2_ < 0)
         {
            return;
         }
         var_480.splice(_loc2_,1);
         var _loc3_:int = -1;
         while(_loc3_ >= 0)
         {
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_478 != null)
         {
            return var_478.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(var_43.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = var_479.indexOf(param1);
            if(_loc2_ >= 0)
            {
               var_479.splice(_loc2_,1);
            }
            if(false)
            {
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = var_394.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = var_394.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_478.createRoomObjectLogic(_loc18_);
