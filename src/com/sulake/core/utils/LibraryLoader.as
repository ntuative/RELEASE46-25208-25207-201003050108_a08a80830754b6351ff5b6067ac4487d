package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1389:int = 5;
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_353 = this.getDefinition(_name) as Class;
         if(var_353 == null)
         {
         ...
         try
         {
            xmlClass = var_353.manifest as Class;
            if(xmlClass == null)
            {
               return;
            }
         ...
         var_513 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               ...
               debug("Load event STATUS " + var_361 + " for file \"" + var_14.contentLoaderInfo.url + "\"");
               break;
            case Event.UNLOAD:
      ...
      protected function handleHttpStatus(param1:int) : Boolean
      {
         if(param1 >= 400)
         {
            if(var_927 > 0)
            {
               var_14.close();
               var_14.unload();
               addRequestCounterToUrlRequest(var_315,const_1389 - var_927);
