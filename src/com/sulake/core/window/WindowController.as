package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private var var_310:Rectangle;
      
      protected var var_617:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(!var_16)
         {
            var_16 = getGraphicContext(!testParamFlag(WindowParam.const_31));
         }
         _events = new EventDispatcher(this);
         _children = new Array();
         var_310 = new Rectangle();
         if(_loc12_ != null)
         {
         ...
         if(_loc9_)
         {
            ...
            if(param2)
            {
               ...
               while(_loc3_ < _loc10_)
               {
                  ...
                  _loc13_ = param1.testParamFlag(WindowParam.const_82);
                  if(_loc13_)
                  {
                     param1.setParamFlag(WindowParam.const_82,false);
                  }
                  param1.offset(-_loc4_,-_loc5_);
                  if(_loc13_)
                  {
                     param1.setParamFlag(WindowParam.const_82,true);
                  }
                  _loc3_++;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_125,WindowParam.const_141);
         var _loc2_:* = !testParamFlag(WindowParam.const_116,WindowParam.const_134);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_5.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_238)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_335)
               {
                  _loc3_.x += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_158)
               {
                  if(var_6.width < _loc3_.width && getParamFlag(WindowParam.const_31))
                  {
                     _loc3_.x = 0;
                  }
                  else
            ...
            if(_loc2_)
            {
               _loc4_ = 0 - 0;
               _loc5_ = uint(var_15 & 0);
               if(_loc5_ == WindowParam.const_232)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_298)
               {
                  _loc3_.y += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_154)
               {
                  if(var_6.height < _loc3_.height && getParamFlag(WindowParam.const_31))
                  {
                     _loc3_.y = 0;
                  }
                  else
         ...
         else if(testParamFlag(WindowParam.const_82))
         {
            _loc3_ = var_5.clone();
            if(var_6 != null)
            {
      ...
      {
         var_745 = param1;
         var_615 = !!var_745 ? uint(var_615 | var_1374) : uint(var_615 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2202 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_958:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1337:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1198:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_792:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_288:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_504:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_832:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_839:
               _loc2_ = "null";
               _loc4_ = true;
               break;
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_16)
         {
            var_16 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_548,var_5);
            var_16.visible = var_347;
         }
         return var_16;
      }
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1006,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      {
         var_396 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_5,WindowRedrawFlag.const_996);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1075 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_334,this,param1));
         return param1;
      }
      ...
      {
         return !testParamFlag(WindowParam.const_31) || var_16 != null;
      }
      ...
      {
         var_1374 = param1 & 4278190080;
         var_615 = !!var_745 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_5,WindowRedrawFlag.const_70);
      }
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_909;
                  if(testParamFlag(WindowParam.const_295))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_192))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_192))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_194:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_399,this,null));
                     if(testParamFlag(WindowParam.const_158,WindowParam.const_141))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_154,WindowParam.const_134))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_6 != null)
                     {
                        ...
                        var_15 = _loc8_;
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_239,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_405:
                  _context.invalidate(this,var_5.union(var_54),WindowRedrawFlag.const_452);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_908,this,null));
                     if(var_6 != null)
                     {
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_229,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_318:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_722,this,null));
                     if(var_6 != null)
                     {
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_210,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_389:
               ...
               case WindowNotifyEvent.const_374:
                  if(!(var_15 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_5,WindowRedrawFlag.const_452);
                     }
                  }
                  else if(var_15 & 0)
                  {
               ...
               case WindowNotifyEvent.const_210:
                  ...
                  break;
               case WindowNotifyEvent.const_399:
                  var_6.getRegionProperties(null,var_310);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_334:
      ...
      {
         return var_617 != null ? var_617 : (var_6 != null ? var_6.procedure : nullEventProc);
      }
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_839,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_720,this,param1));
         return param1;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_626;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1075 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      {
         return !testParamFlag(WindowParam.const_31) ? getGraphicContext(true).fetchDrawBuffer() : (var_6 != null ? var_6.fetchDrawBuffer() : null);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            var_32 = param1;
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_389,this,null));
         }
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            _loc7_ = uint(var_15 & 0);
            if(_loc7_ == WindowParam.const_371)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_398)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         }
         if(testParamFlag(WindowParam.const_82))
         {
            if(var_6 != null)
            {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_918,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_685,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_194,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1244,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         if(var_162 && var_746 > 0)
         {
            if(!testParamFlag(WindowParam.const_31))
            {
               if(param1.x <= var_5.width && param1.y <= var_5.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1550,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1550,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1140,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_61,false);
         _loc1_.type = WindowNotifyEvent.const_1186;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_6 != param1)
         {
            ...
            if(var_6 != null)
            {
               var_310 = var_6.rectangle.clone();
               var_54.x = var_5.x;
               var_54.y = var_5.y;
               var_54.width = var_5.width;
               var_54.height = var_5.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_453,this,var_6));
            }
            else
            {
               var_310.x = 0;
               ...
               var_310.width = 0;
               var_310.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_849,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_81,var_15,_context,var_5,null,var_617,properties,var_616.concat(),_id) as WindowController;
         _loc2_.var_746 = var_746;
         _loc2_.var_162 = var_162;
         _loc2_._debug = _debug;
         _loc2_.var_310 = var_310.clone();
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_403;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         if(var_32 == WindowState.const_423)
         {
            return true;
         }
         var_32 = WindowState.const_423;
