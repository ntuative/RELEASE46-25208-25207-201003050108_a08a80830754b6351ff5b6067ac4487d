package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_922:ITabSelectorWindow;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1585 == null)
         {
            var_1585 = findChildByTag(TabContextController.TAB_CONTEXT_CONTENT_TAG) as IWindowContainer;
         }
         return var_1585;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_922 == null)
         {
            var_922 = findChildByTag(TabContextController.TAB_CONTEXT_SELECTOR_TAG) as ITabSelectorWindow;
            if(var_922 != null)
            {
               var_922.procedure = selectorEventProc;
            }
         }
         return var_922;
      }
      ...
      {
         return !!var_849 ? selector.iterator : null;
      }
