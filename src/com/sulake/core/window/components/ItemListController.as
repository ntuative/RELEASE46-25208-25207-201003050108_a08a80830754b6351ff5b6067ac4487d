package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1023:String = "resize_on_item_update";
      ...
      protected static const const_1025:String = "scale_to_fit_items";
      ...
      protected var var_525:Boolean = false;
      
      protected var var_2329:Number = 0;
      
      protected var var_523:Number;
      
      protected var var_1096:Boolean = false;
      ...
      protected var var_1368:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_90 = 0;
         var_68 = 0;
         _horizontal = param2 == WindowType.const_296;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_162 = var_745 || !testParamFlag(WindowParam.const_31);
         _container = _context.create("_CONTAINER","",WindowType.const_329,WindowStyle.const_317,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         ...
         _container.addEventListener(WindowEvent.const_286,containerEventHandler);
         _container.addEventListener(WindowEvent.const_437,containerEventHandler);
         resizeOnItemUpdate = var_1096;
      }
      ...
      {
         return new Rectangle(var_523 * maxScrollH,var_524 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_286,containerEventHandler);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1022,_spacing,PropertyStruct.const_62,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1024,var_742,PropertyStruct.const_56,var_742 != const_1386));
         _loc1_.push(new PropertyStruct(const_1025,var_525,PropertyStruct.const_56,var_525 != const_1387));
         _loc1_.push(new PropertyStruct(const_1023,var_1096,PropertyStruct.const_56,var_1096 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            var_524 = param1;
            _container.y = -var_524 * maxScrollV;
            _context.invalidate(_container,visibleRegion,WindowRedrawFlag.const_70);
         }
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_359,param1);
            }
            else
            {
