   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_334)
         {
            ...
            if(var_334)
            {
               var_334.addEventListener(WindowEvent.const_265,scrollBarEventProc);
               var_334.addEventListener(WindowEvent.const_193,scrollBarEventProc);
            }
         }
         return var_334;
      }
      ...
      override public function dispose() : void
      {
         if(var_334)
         {
            var_334.removeEventListener(WindowEvent.const_265,scrollBarEventProc);
            var_334.removeEventListener(WindowEvent.const_193,scrollBarEventProc);
            var_334 = null;
         }
         if(var_817)
         {
      ...
      {
         if(param1.type == WindowEvent.const_265)
         {
            showScrollBar();
         }
         else if(param1.type == WindowEvent.const_193)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_817)
         {
            var_817 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_817;
      }
