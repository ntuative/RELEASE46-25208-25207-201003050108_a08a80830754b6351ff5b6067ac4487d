package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_433 = new Array();
         var_433[0] = MouseCursorType.const_311;
         var_433[1] = MouseCursorType.const_36;
         var_433[2] = MouseCursorType.const_311;
         var_433[3] = MouseCursorType.const_311;
         var_433[4] = MouseCursorType.const_36;
         var_433[5] = MouseCursorType.const_36;
         var_433[6] = MouseCursorType.const_311;
         if(var_320 == null)
         {
            var_320 = new Array();
            var_320[0] = WindowState.const_87;
            ...
            var_320[6] = WindowState.const_68;
         }
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         ...
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_1000,param1.toolTipDelay != const_1388));
         return param2;
      }
      ...
      {
         var_930 = param1 == null ? const_738 : param1;
      }
