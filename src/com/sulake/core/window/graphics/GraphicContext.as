package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_921:uint = 256;
      
      protected static var var_620:uint = 0;
      
      protected static var var_367:uint = 0;
      
      public static const const_841:uint = 2;
      
      public static const const_1571:uint = 128;
      
      public static const const_1551:uint = 64;
      
      public static const const_526:uint = 4;
      
      public static const const_1290:uint = 0;
      
      public static const const_1289:uint = 16;
      
      public static const const_548:uint = 1;
      
      public static const const_1259:uint = 8;
      ...
      protected var var_1586:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1259:
               ...
               break;
            case GraphicContext.const_1289:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_526:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_921:
               break;
            case GraphicContext.const_1290:
               break;
            default:
         ...
         if(var_614)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1586,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1586,16777215);
                  }
                  var_367 += bitmap.width * bitmap.height * 4;
               }
