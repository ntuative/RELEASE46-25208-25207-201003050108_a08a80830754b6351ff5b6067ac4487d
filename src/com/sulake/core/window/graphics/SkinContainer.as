package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1417 = new Dictionary();
         var_1806 = new Dictionary();
         TypeCodeTable.fillTables(var_1417,var_1806);
         var_1150 = new Dictionary();
         var_1805 = new Dictionary();
         StateCodeTable.fillTables(var_1150,var_1805);
         var_449 = new Dictionary();
         var_449["skin"] = BitmapSkinRenderer;
         var_449["bitmap"] = BitmapDataRenderer;
         var_449["fill"] = FillSkinRenderer;
         var_449["text"] = TextSkinRenderer;
         var_449["shape"] = ShapeSkinRenderer;
         var_449["unknown"] = SkinRenderer;
         var_449["null"] = NullSkinRenderer;
         if(var_366 == null)
         {
            var_366 = new Array();
            var_366.push(WindowState.const_61);
            var_366.push(WindowState.const_68);
         ...
         for(_loc4_ in var_1150)
         {
            _loc3_.push(var_1150[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1417[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_540[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_540[param1] = new Array(SkinContainer.MAX_STYLE_COUNT);
         }
         var_540[param1][param2] = param3;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinRenderer(var_540[_loc1_]).dispose();
