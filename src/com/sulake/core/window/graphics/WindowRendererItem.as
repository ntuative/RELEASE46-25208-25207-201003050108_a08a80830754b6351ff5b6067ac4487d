package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_496:uint = 0;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_452:
               ...
               break;
            case WindowRedrawFlag.const_803:
               var_710 = var_709.getTheActualState(param1.type,param1.style,param1.state);
               if(var_710 != var_1070)
               {
                  var_234 = true;
                  _loc4_ = true;
            ...
            case WindowRedrawFlag.const_996:
               ...
               break;
            case WindowRedrawFlag.const_257:
               _loc4_ = true;
         }
         if(_loc4_)
         {
      ...
      {
         return var_709.getTheActualState(param1.type,param1.style,param1.state) != var_1070;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc10_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_783) : uint(const_496);
         var _loc6_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc6_ != null)
         {
            _loc5_ = !!_loc6_.isStateDrawable(var_710) ? uint(const_782) : uint(_loc5_);
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_782)
               {
                  ...
                  if(var_234)
                  {
                     ...
                     _loc6_.draw(param1,var_95,var_95.rect,var_710,false);
                     if(!param1.background)
                     {
                        _loc10_ = uint(param1.color);
                        if((_loc10_ & 16777215) < 16777215)
                        {
                           var_95.colorTransform(_loc4_.rect,new ColorTransform(((_loc10_ & 16711680) >> 16) / 255,((_loc10_ & 65280) >> 8) / 255,(_loc10_ & 255) / 255));
                        }
                     }
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_31))
                  {
                     ...
                     _loc4_.draw(var_95,var_925,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = var_709.getSkinRendererByType(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_811)
            {
               _loc2_ = var_709.getSkinRendererByType(param1.type,WindowStyle.const_811);
            }
         }
         return _loc2_;
      }
