package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_51:DisplayObjectContainer;
      
      private var _disposed:Boolean;
      
      private var var_709:ISkinContainer;
      
      private var var_1511:Rectangle;
      ...
      private var var_303:Rectangle;
      
      private var var_1512:Point;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_586 = new Array();
         var_1512 = new Point();
         var_1511 = new Rectangle();
         var_303 = new Rectangle();
         var_304 = new Dictionary(true);
         var_709 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_304[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_586.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = getWindowRendererItem(_loc1_);
               var_303.x = _loc3_.dirty.x;
               var_303.y = _loc3_.dirty.y;
               var_303.width = _loc3_.dirty.width;
               var_303.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_303);
            }
            _loc4_++;
         }
      }
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_520,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_304[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete var_304[param1];
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1512,var_1511))
            {
               if(param2.render(param1,var_1512,var_1511))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,_drawBufferAllocator,var_709);
            var_304[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_520,windowDisposedCallback);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_303.x = param2.x - param1.x;
            var_303.y = param2.y - param1.y;
            var_303.width = param2.width;
            var_303.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_31))
            {
               while(param1.testParamFlag(WindowParam.const_31))
               {
                  ...
                  var_303.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_303,WindowRedrawFlag.const_257);
            if(var_586.indexOf(param1) == -1)
            {
               var_586.push(param1);
            }
         }
