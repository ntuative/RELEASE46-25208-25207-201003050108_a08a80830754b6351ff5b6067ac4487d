package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public static const const_622:String = "Rectangle";
      ...
      public static const const_675:String = "Point";
      
      public static const const_875:String = "Array";
      
      public static const const_1000:String = "uint";
      
      public static const const_425:String = "hex";
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean)
      {
         ...
         _type = param3;
         var_1747 = param4;
         var_2286 = param3 == const_834 || param3 == const_875 || param3 == const_675 || param3 == const_622;
      }
      ...
      public function toXMLString() : String
      {
         ...
         switch(_type)
         {
            ...
            case const_622:
               ...
               break;
            case const_425:
               _loc1_ = "<var key=\"" + var_536 + "\" value=\"" + "0x" + uint(var_164).toString(16) + "\" type=\"" + _type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + var_536 + "\" value=\"" + var_164 + "\" type=\"" + _type + "\" />";
         }
         return _loc1_;
      }
