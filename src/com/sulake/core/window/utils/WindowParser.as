package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1597:String = "_INCLUDE";
      
      public static const const_892:String = "_EXCLUDE";
      
      public static const const_1566:String = "_TEMP";
      
      private static const const_1092:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1091:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_926:Dictionary;
      
      protected var var_1371:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1370:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         var_1370 = new Dictionary();
         ParamCodeTable.fillTables(var_926,var_1370);
         var_1371 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1091,"");
         return param1.replace(const_1092,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_926)
            {
               delete var_926[_loc1_];
            }
            for(_loc1_ in var_1370)
            {
               delete var_1370[_loc1_];
            }
            var_1371.dispose();
            var_1371 = null;
            _context = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_892) == -1)
                  {
