package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1174:int = 10000;
      ...
      private var var_712:IEncryption;
      
      private var var_711:int;
      
      private var var_352:ByteArray;
      ...
      private var var_599:IProtocol;
      
      private var var_885:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         _id = param1;
         var_306 = param2;
         var_352 = new ByteArray();
         var_885 = new MessageClassManager();
         var_80 = new Socket();
         var_351 = new Timer(const_1174,1);
      ...
      {
         var_351.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - var_711));
      ...
      {
         var_351.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - var_711));
      ...
      {
         var_351.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - var_711));
         dispatchEvent(param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_885.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            return false;
         }
         var _loc5_:ByteArray = var_599.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(var_350)
         {
         ...
         if(var_712 != null)
         {
            _loc3_ = var_712.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_352.writeByte(var_80.readUnsignedByte());
         }
      }
      ...
      {
         var_885.registerMessages(param1);
      }
      ...
      {
         var_351.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - var_711));
         dispatchEvent(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_599.getMessages(var_352,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            _loc7_ = var_885.getMessageEventClasses(_loc5_);
            _loc8_ = new Array();
         ...
         else if(_loc2_ > 0)
         {
            ...
            _loc18_.writeBytes(var_352,_loc2_);
            var_352 = _loc18_;
         }
      }
      ...
      {
         var_351.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - var_711));
         switch(param1.type)
         {
      ...
      {
         var_351.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - var_711));
         dispatchEvent(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_712 + "\n");
      }
   }
}
