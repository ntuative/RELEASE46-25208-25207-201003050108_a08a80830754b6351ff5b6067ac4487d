package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_853:String = "AssetLibraryReady";
      
      public static const const_1339:String = "AssetLibraryUnloaded";
      
      public static const const_438:String = "AssetLibraryLoaded";
      
      public static const const_1323:String = "AssetLibraryLoadError";
       
      
      private var var_513:XML;
      ...
      private var var_512:Boolean = true;
      
      private var var_353:Class;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_602;
         var_421 = new Dictionary(false);
         var_422 = new Dictionary(false);
         var_721 = new Dictionary(false);
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_421)
         {
            _loc4_ = AssetTypeDeclaration(var_421[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_513 = _loc2_.manifest.copy();
         var_353 = _loc2_.resource;
         if(var_512)
         {
            AssetLibrary.fetchLibraryContents(this,var_513,var_353);
         }
         var_309 = true;
         dispatchEvent(new Event(AssetLibrary.const_438));
         dispatchEvent(new Event(AssetLibrary.const_853));
         if(var_512)
         {
            var_14.dispose();
            var_14 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_422[param2.url];
         if(_loc4_ != null)
         {
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_421.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_421[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      {
         return param1 < var_354.length ? getAssetByName(var_354[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1323));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_421)
         {
            _loc3_ = AssetTypeDeclaration(var_421[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_721[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_513.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_353[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_422[loader.url];
         if(struct == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_354.splice(var_354.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_421[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_353 != null ? false : false;
      }
   }
}
