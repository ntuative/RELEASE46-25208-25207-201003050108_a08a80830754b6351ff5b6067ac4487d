package com.hurlant.crypto.prng
{
   ...
   public class Random
   {
      ...
      public function Random(param1:Class = null)
      {
         ...
         var_122 = new ByteArray();
         var_50 = 0;
         while(var_50 < psize)
         {
            _loc2_ = uint(65536 * Math.random());
            var _loc3_:* = var_50++;
            var_122[_loc3_] = _loc2_ >>> 8;
            var _loc4_:*;
            var_122[_loc4_ = var_50++] = _loc2_ & 255;
         }
         var_50 = 0;
         seed();
      }
      ...
      public function seed(param1:int = 0) : void
      {
         ...
         var _loc2_:* = var_50++;
         var_122[_loc2_] = 0 ^ param1 & 255;
         var _loc3_:* = var_50++;
         var_122[_loc3_] = 0 ^ param1 >> 8 & 255;
         var _loc4_:*;
         var_122[_loc4_ = var_50++] = 0 ^ param1 >> 16 & 255;
         var _loc5_:*;
         var_122[_loc5_ = var_50++] = 0 ^ param1 >> 24 & 255;
         var_50 %= psize;
         var_1648 = true;
      }
      ...
      {
         var _loc1_:int = 0;
         while(_loc1_ < var_122.length)
         {
            var_122[_loc1_] = Math.random() * 256;
            _loc1_++;
         }
         var_122.length = 0;
         var_122 = null;
