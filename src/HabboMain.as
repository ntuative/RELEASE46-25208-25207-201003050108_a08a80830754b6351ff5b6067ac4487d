package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      {
         var _loc7_:Sprite = param1.getChildByName(Habbo.const_1) as Sprite;
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         {
            var_31.error("Failed to download external configuration document " + _loc2_.assetLoader.url + "!",true,Core.const_859);
